...
$description_text = '<p class="p200">IPL, som står för Intensivt Pulserande Ljus, är en effektiv och icke-invasiv behandlingsmetod speciellt användbar för att hantera symtom på rosacea. Denna ljusbaserade teknik som liknar laserbehandling sänder ut pulser av ljus som varsamt tränger igenom huden och behandlar rosacea genom att minska rodnad och inflammation. IPL verkar genom att rikta in sig på de små blodkärlen som bidrar till rosaceas karakteristiska rodnad och synliga blodkärl.</p>
    <p class="p200 mt-m">IPL mot <a class="b200 underline color-deep-sea-400" href="/rosacea.php" title="Mer information om rosacea i ansiktet">rosacea i ansiktet</a> minskar rodnaden och jämnar ut hudtonen. Behandlingen lugnar också huden så att utbrotten blir färre. Som <a class="b200 underline color-deep-sea-400" href="/rosaceabehandling.php" title="Mer information om rosaceabehandlingr">rosacea behandling</a> anpassas den efter din hud och innebär liten risk för biverkningar. Många ser tydligt mindre rodnad och färre ytliga blodkärl redan efter några <a class="b200 underline color-deep-sea-400" href="/ipl-ytliga-blodkarl.php" title="Mer information om IPL behandling">IPL behandlingar</a>.</p>';
...
$top_articles = array(
    'preparing' => new Article(
        ...
        content: '<p class="p200">Förberedelserna börjar med en konsultation. Vi tittar på din hudtyp och hur uttalad din rosacea är. Utifrån det lägger vi upp en plan för dina IPL-behandlingar.</p>
        <p class="p200 mt-m">Undvik sol och självbrunande produkter minst två veckor innan. IPL riktar in sig på pigment och blodkärl, så solbränd eller självbrunad hud ökar risken för ojämn pigmentering. Veckan före bör du också avstå från produkter med retinol, starka syror eller andra exfolierande ämnen, eftersom de gör huden känsligare och lättare att irritera.</p>',
    ),
    'process' => new Article(
        ...
        <p class="p200 mt-m">Vi ställer in ljuspulsens intensitet och våglängd. Sedan för vi IPL-enheten över de områden där rosacean syns och skickar korta, intensiva ljuspulser ner i huden. Ljuset tas upp av de blodkärl som ger rodnaden och gör dem mindre framträdande utan att den omgivande huden skadas.</p>
        <p class="p200 mt-m">Direkt efter en IPL-behandling känns området ofta varmt och ser lite rött ut, ungefär som en mild solbränna. Det går över inom några timmar till ett par dagar. Rodnaden minskar sedan gradvis under behandlingsserien och du ser resultatet växa fram efter hand.</p>',
    ),
);
...
$bottom_articles = array('aftercare' => new Article(
    ...
    content: '<p class="p200">Håll området rent och rör det inte med smutsiga händer. Avstå från smink och parfymerade produkter det första dygnet så att huden inte blir irriterad eller infekterad. En lätt svullnad kan förekomma direkt efteråt och lägger sig inom kort.</p>
    <p class="p200 mt-m">De första dagarna bör du undvika hård träning, bastu och långa heta duschar, eftersom värme och svettning kan förvärra svullnad och irritation. Skydda huden mot solen. Smörj in det behandlade området med en solkräm med hög SPF regelbundet, annars kan nya solskador uppstå. Använd gärna milda, återfuktande produkter utan irriterande ingredienser för att lugna huden och hålla kvar fukten.</p>
