...
$trivias = array(
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Denna hudåkomma är mest vanlig under tonåren på grund av de hormonella förändringarna som sker i kroppen, men den kan även påverka vuxna. Finnar presenterar sig i flera olika former, från lindriga tillstånd som svarta och vita prickar till mer intensiva utbrott som cystor och noduler. Oavsett graden av utbrott, är det möjligt att behandla finnar och minska risken för ärrbildning och andra långsiktiga effekter på huden.</p>       
            <p class="p200 mt-xl">På AcneSpecialisten erbjuder vi skräddarsydda behandlingslösningar för alla typer av finnar. Vår erfarna personal använder sig av beprövade metoder för att ge dig den bästa möjliga hudvården. Genom en kostnadsfri hudkonsultation kartlägger vi dina specifika behov och utvecklar en personlig behandlingsplan. Vi tar även fram en behandlingsplan för hur du behandlar huden hemma, så att du kan upprätthålla en hälsosam hudvårdsrutin och optimera dina behandlingsresultat.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            title: 'får man finnar?',
            content: '<p class="p200">Finnar är en hudåkomma som uppstår när talgkörtlar i huden överproducerar talg, ofta på grund av genetiska, hormonella, och miljömässiga faktorer. En viss mängd talg är essentiell för att huden ska förbli hälsosam, men ett överskott kan resultera i blockeringar av porerna. Dessa blockeringar, tillsammans med ackumulering av döda hudceller, skapar en gynnsam miljö för bakterietillväxt. Kroppens naturliga respons på denna bakterietillväxt är inflammation, vilket visar sig som finnar på huden.</p>',
            extended_content: '<p class="p200 mt-xl">Hormonella förändringar, särskilt under puberteten, kan leda till ökad talgproduktion, men även stress, vissa mediciner, och miljöfaktorer som varma, fuktiga klimat kan bidra. Livshändelser som graviditet, menstruation och menopaus, liksom användning av anabola steroider och vissa typer av preventivmedel, kan också påverka uppkomsten av finnar. Stress, både från större och mindre händelser, kan förvärra hudtillstånd genom att öka kroppens produktion av talg, vilket i sin tur kan leda till finnar.</p>
