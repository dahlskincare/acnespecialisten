...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_Pimples', 'Boka gratis konsultation för finnar'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=facialProblem&problem=Problem_Pimples', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_Pimples', 'Boka gratis konsultation för finnar'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=facialProblem&problem=Problem_Pimples', 'Boka denna behandling'),
      ],
...
$treatment_steps = array(
      new TreatmentStep(
            ...
            url: 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_Pimples',
      ...
      new TreatmentStep(
            ...
            url: 'https://www.acnespecialisten.se/book?flow=problem&problem=Problem_Pimples',
...
$services = array(
      ...
      new Service(
            ...
            consultation_url: 'https://www.acnespecialisten.se/book?flow=problem&problem=Problem_Pimples&method=Method_LaserProblem',
            consultation_url_label: 'Boka konsultation',
            consultation_url_title: 'Klicka här för att boka tid för en hudkonsultation för laserbehandling mot finnar',
            booking_url: 'https://www.acnespecialisten.se/book?flow=laserProblem&skipable_problem=SKIP',
            booking_url_label: 'Boka behandling',
      ...
      new Service(
            ...
            booking_url: 'https://www.acnespecialisten.se/book?flow=chemicalpeeling&skipable_problem=SKIP',
            booking_url_label: 'Boka behandling',
      ...
      new Service(
            ...
            booking_url: 'https://www.acnespecialisten.se/book?flow=microneedling&skipable_problem=SKIP',
            booking_url_label: 'Boka behandling',
