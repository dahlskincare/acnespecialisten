...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Hormonella förändringar, särskilt under puberteten, kan leda till ökad talgproduktion, men även stress, vissa mediciner, och miljöfaktorer som varma, fuktiga klimat kan bidra. Livshändelser som <a class="b200 underline color-deep-sea-400" href="finnar-graviditet.php">graviditet</a>, menstruation och klimakteriet, liksom användning av anabola steroider och vissa typer av preventivmedel, kan också påverka uppkomsten av finnar. Stress, både från större och mindre händelser, kan förvärra hudtillstånd genom att öka kroppens produktion av talg, vilket i sin tur kan leda till finnar.</p>
