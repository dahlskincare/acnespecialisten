...
$results_images = array(
      new LabelImage(
            ...
            image_alt: 'Milda finnar före och efter behandling',
            image_title: 'Resultat - milda finnar',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Resultat - finnar i ansiktet',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Resultat - finnar på kinder och panna',
            content: '',
      ),
      new LabelImage(
      ...
      new LabelImage(
            ...
            image_alt: 'Inflammerade finnar före och efter behandling',
            image_title: 'Resultat - inflammerade finnar',
            content: '',
      ),
      new LabelImage(
      ...
      new LabelImage(
            ...
            image_alt: 'Finnar på kind och hals före och efter behandling',
            image_title: 'Resultat - finnar på kind och hals',
            content: '',
      ),
      new LabelImage(
      ...
      new LabelImage(
            ...
            image_alt: 'Många finnar före och efter behandling',
            image_title: 'Resultat - många finnar',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Resultat - finnar på kinder och haka',
            content: '',
      ),
);
...
$specialists = array(
      new Specialist(
            ...
            image_alt: 'Cazzandra L, hudterapeut med specialisering i finnar och hudvård',
            image_title: 'Cazzandra L - Expert på behandling av finnar'
      ),
      new Specialist(
      ...
      new Specialist(
            ...
            image_alt: 'Julia Eklund, hudterapeut med kunskap inom behandling av finnar',
            image_title: 'Julia Eklund - Hudterapeut specialiserad på finnar'
      ),
      new Specialist(
            name: 'Vilma Libom',
      ...
      <main>
            ...
            <div class="container">
                  <div id="content">
                        ...
                        <section id="results">
                              <?php
                              $results_title = 'Finnar före och efter bilder';
