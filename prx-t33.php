...
$model = new Service(
    ...
    booking_url: 'https://boka.acnespecialisten.se?flow=chemicalpeeling&skipable_problem=SKIP&area=Service_ChemicalPeeling_PRX',
...
$types = array(
    new Service(
        ...
        consultation_url_title: 'Boka tid för hudkonsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_AcneScars',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_PigmentationSpots',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_Melasma',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_Wrinkles',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_LargePores',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_StrechMarks',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=prx&skipable_problem=Problem_Acne',
        booking_url_label: 'Boka behandling',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i PRX T33-behandling',
        image_title: 'Cazzandra L - Expert på PRX T33-behandling'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom PRX T33-behandling',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på PRX T33'
    ),
    new Specialist(
        name: 'Vilma Libom',
