...
<head>
    ...
    <title>Utbildningsdag | AcneSpecialisten – Hudvård i Stockholm</title>
    <meta name="description" content="Läs om AcneSpecialistens Utbildningsdag.">
    <meta name="keywords" content="Utbildningsdag">
...
<body>
    ...
    <main>
        ...
        <div class="container">
            <div id="content">
                <section id="title">
                    <h1 class="l10n">Utbildningsdag</h1>
                    <p class="l10n">Just nu har vi inga planerade utbildningsdagar.</p>
                </section>
            </div>
