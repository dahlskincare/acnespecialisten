    ...
    new ServiceCategory(
        ...
        services: array(
            ...
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för Microdermabrasion',
                booking_url_title: 'Boka tid för Microdermabrasion',
            ),
        ),
    ...
    new ServiceCategory(
        ...
        services: array(
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för IPL Rosacea',
                booking_url_title: 'Boka tid för IPL Rosacea',
            ),
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för IPL Ytliga Blodkärl',
                booking_url_title: 'Boka tid för IPL Ytliga Blodkärl',
            ),
            new Service(
    ...
    new ServiceCategory(
        ...
        services: array(
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för Skin Tech',
                booking_url_title: 'Boka tid för Skin Tech',
            ),
            new Service(
    ...
    new ServiceCategory(
        ...
        services: array(
            ...
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för Alma Harmony XL Pro',
                booking_url_title: 'Boka tid för Alma Harmony XL Pro',
            ),
        ),
    ...
    new ServiceCategory(
        ...
        services: array(
            ...
            new Service(
                ...
                consultation_url_title: 'Boka tid för hudkonsultation',
                booking_url: 'https://bokadirekt.se',
                booking_url_label: 'Boka tid för Exceed',
                booking_url_title: 'Boka tid för Exceed',
            ),
        ),
