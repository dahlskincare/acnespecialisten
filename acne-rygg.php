...
$articles = array(
      new Article(
            ...
            content: '<p class="p200">Akne på ryggen, även kallad “bacne,” kan vara både frustrerande och smärtsamt. Precis som ansiktsakne uppstår ryggakne när hårsäckarna täpps till av döda hudceller och talg. Bakterier växer i dessa tilltäppta hårsäckar, vilket leder till inflammation och finnar.</p>
              <p class="p200 mt-m">För att effektivt hantera och behandla <a class="b200 underline color-deep-sea-400" href="/finnar-rygg.php" title="Mer information om finnar på ryggen">finnar på ryggen</a> är det viktigt att förstå dess orsaker. Hormonella förändringar, genetik, svett och friktion från kläder är vanliga bidragande faktorer. På grund av ryggens stora yta och svåråtkomliga läge kan behandlingen vara utmanande. Effektiv <a class="b200 underline color-deep-sea-400" href="/acnebehandling.php" title="Mer information om akne på ryggen behandlingar">akne på ryggen behandling</a> bestå av en kombination av daglig hudvårdsrutin som är specialiseradekan för att hjälpa till att minska och förebygga akne på ryggen.</p>',
            image_small: null,
            image_large: null,
            image_alt: '',
            image_title: '',
...
$results_images = array(
      new LabelImage(
            ...
            image_title: 'Akne resultat - hela ryggen',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Akne resultat - ryggen',
            content: '',
      ),
      new LabelImage(
      ...
      new LabelImage(
            ...
            image_title: 'Akne resultat - kind och hals',
            content: '',
      ),
      new LabelImage(
            image_url: '/bilder/resultat/832x476/akne/akne-finnar-resultat-fore-efter-sida.webp',
            image_alt: 'Akne i ansiktet från sidan före och efter behandling',
            image_title: 'Akne resultat - ansikte från sidan',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Akne resultat - aktiv akne',
            content: '',
      ),
      new LabelImage(
            image_url: '/bilder/resultat/832x476/akne/akne-finnar-resultat-fore-efter-en-stor.webp',
            image_alt: 'Stor inflammerad finne i ansiktet före och efter behandling',
            image_title: 'Akne resultat - inflammerad finne',
            content: '',
      ),
      new LabelImage(
            image_url: '/bilder/resultat/832x476/akne/akne-finnar-resultat-fore-efter-flackar.webp',
            image_alt: 'Pigmentfläckar efter akne i ansiktet före och efter behandling',
            image_title: 'Akne resultat - pigmentfläckar',
            content: '',
      ),
      new LabelImage(
            image_url: '/bilder/resultat/832x476/akne/akne-finnar-resultat-fore-efter-prickar.webp',
            image_alt: 'Punktformig akne i ansiktet före och efter behandling',
            image_title: 'Akne resultat - prickar',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Akne resultat - utslag',
            content: '',
      ),
);
