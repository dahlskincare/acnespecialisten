...
$model = new Service(
    ...
    procedures: array(
        new Procedure(
            ...
            price: '2995 kr',
            savings: null,
            booking_url: 'https://boka.acnespecialisten.se?flow=infuzion&area=Infuzion_1xArea&procedures=PriceClass_6_Procedure_1',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Infuzion-behandlingar',
        image_title: 'Cazzandra L - Expert på Infuzion-behandlingar'
    ),
    new Specialist(
