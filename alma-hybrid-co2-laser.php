...
$model = new Service(
    ...
    booking_url: 'https://boka.acnespecialisten.se?flow=co2laser',
...
$types = array(
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_AcneScars',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_Scars&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_StrechMarks',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_LargePores&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_Wrinkles&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_PigmentationSpots',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka gratis konsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=Problem_Acne',
        booking_url_label: 'Boka behandling',
    ...
    new TreatmentArea(
        ...
        items: array(
            ...
            new TreatmentAreaItem(
                ...
                duration: '100 min',
                price: '6595 kr',
                url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=SKIP&area=Laser_2xAreas',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '110 min',
                price: '7595 kr',
                url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=SKIP&area=Laser_3xAreas',
                url_label: 'Boka',
...
$results_images = array(
    new LabelImage(
        ...
        image_alt: 'CO2-laser behandling av näsan före och efter',
        image_title: 'Alma Hybrid resultat - näsa',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/arr/arr-resultat-fore-efter-flackar.webp',
        image_alt: 'Ärr och fläckar före och efter CO2-laser',
        image_title: 'Alma Hybrid resultat - ärr och fläckar',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/co2-laser/co2-laser-resultat-fore-efter-ogonvra.webp',
        image_alt: 'CO2-laser behandling av ögonvrå före och efter',
        image_title: 'Alma Hybrid resultat - ögonvrå',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/hudforandringar/hudforandringar-resultat-fore-efter-nyckelben.webp',
        image_alt: 'Hudförändringar på nyckelben före och efter CO2-laser',
        image_title: 'Alma Hybrid resultat - hudförändringar',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/co2-laser/co2-laser-resultat-fore-efter-porig-hy.webp',
        image_alt: 'Porig hy före och efter CO2-laser behandling',
        image_title: 'Alma Hybrid resultat - porig hy',
        content: '',
    ),
    new LabelImage(
        ...
        image_title: 'Alma Hybrid resultat - hudföryngring',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/arr/arr-resultat-fore-efter-tinning.webp',
        image_alt: 'Ärr på tinningen före och efter CO2-laser',
        image_title: 'Alma Hybrid resultat - ärr på tinningen',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/co2-laser/co2-laser-resultat-fore-efter-fina-linjer.webp',
        image_alt: 'Fina linjer före och efter CO2-laser behandling',
        image_title: 'Alma Hybrid resultat - fina linjer',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/co2-laser/co2-laser-resultat-fore-efter-kaklinje.webp',
        image_alt: 'Käklinje och hudtextur före och efter CO2-laser',
        image_title: 'Alma Hybrid resultat - käklinje',
        content: '',
    ),
    new LabelImage(
        image_url: '/bilder/resultat/832x476/co2-laser/co2-laser-resultat-fore-efter-hudtextur.webp',
        image_alt: 'Hudtextur före och efter CO2-laser behandling',
        image_title: 'Alma Hybrid resultat - hudtextur',
        content: '',
    ),
);
...
$faq_categories = array(
    '' => array(
        ...
        new Question(
            title: 'Kan jag träna efter CO2-laserbehandling?',
            text: '<p class="p200">Nej, du bör undvika fysisk träning och träning på gym de första 2-3 dagarna efter behandlingen. Träning och fysisk ansträngning ökar blodcirkulationen vilket leder till mer svullnad och rodnad i det behandlade området. Detta kan förlänga läkningsprocessen. Vänta tills rodnaden och svullnaden har minskat avsevärt innan du återupptar träning, och börja försiktigt med lättare aktiviteter. Undvik också aktiviteter som får dig att svettas mycket under denna period.</p>'
        ),
    )
);
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Alma Hybrid-behandlingar',
        image_title: 'Cazzandra L - Expert på Alma Hybrid-behandlingar'
    ),
    new Specialist(
