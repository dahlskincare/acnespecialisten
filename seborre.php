...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Seborrhea', 'Boka gratis konsultation'),
      ...
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Seborrhea', 'Boka gratis konsultation'),
            new Link('Boka behandling', 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Seborrea&method=Method_FacialProblem&area=EMPTY', 'Boka denna behandling'),
      ],
...
$specialists = array(
      new Specialist(
            ...
            image_alt: 'Cazzandra L, hudterapeut med specialisering i seborrébehandling',
            image_title: 'Cazzandra L - Expert på seborrébehandling'
      ),
      new Specialist(
      ...
      new Specialist(
            ...
            image_alt: 'Julia Eklund, hudterapeut med kunskap inom seborréhantering',
            image_title: 'Julia Eklund - Hudterapeut specialiserad på seborré'
      ),
      new Specialist(
            name: 'Vilma Libom',
...
<body>
      ...
      <main>
            ...
            <section id="brands">
                  ...
                  <a class="mt-xl button b200 outline expand auto-width is-hidden-desktop l10n" title="Se våra varumärken mot seborre" href="varumarken/">Se alla varumärken</a>
