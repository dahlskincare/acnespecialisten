...
$services = array(
    ...
    new Service(
        ...
        price: '4595 kr',
        icons: array(),
        content: '<p class="p200">Laserbehandling är den främsta strategin för att korrigera atrofiska ärr, vanligen kända som gropar, som är en följd av akne. Genom att fokusera på djupliggande skikt i huden, bidrar laserbehandlingen vid Acnespecialisten inte bara till att minska synligheten av dessa ärr genom att stimulera kollagenproduktionen, utan också genom att främja hudcellsförnyelse. Denna dubbla verkan hjälper till att "fylla ut" groparna och skapar en slätare hudtextur.</p>',
    ...
    new Service(
        ...
        price: '1295 kr',
        icons: array(),
        content: '<p class="p200">Kemisk peeling är optimalt för att ta itu med postinflammatorisk hyperpigmentering – de mörka eller rodnade fläckar som ofta kvarstår efter akne. På Acnespecialisten innebär denna behandling användning av en specialutvecklad lösning för att försiktigt exfoliera och avlägsna de skadade yttersta hudlagren. Detta uppmuntrar ny, felfri hud att växa fram, vilket avsevärt minskar synligheten av dessa missfärgade ärr och leder till en mer enhetlig hudton.</p>',
