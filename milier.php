...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Individer med torr hud eller de som använder olämpliga hudvårdsprodukter som kan täppa till porerna löper en större risk att utveckla milier. Dessutom kan personer som har en genetisk benägenhet eller som har drabbats av vissa typer av hudskador eller inflammatoriska tillstånd även finna sig mer benägna till dessa små cystor. En noggrann bedömning av ens hudvårdsvanor och eventuella genetiska faktorer kan vara hjälpsam för att identifiera och minska risken för milier.</p>',
