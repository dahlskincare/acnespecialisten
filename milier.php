...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är milier?',
            content: '<p class="p200">Milier uppstår när keratin, ett protein som är en central beståndsdel i huden, fastnar under hudytan och bildar små, vita eller ibland gula cystor. Dessa små, hårda kapslar formar sig när döda hudceller inte kan avlägsnas på normalt sätt utan istället blir instängda inne i huden. Det finns flera faktorer som kan bidra till bildandet av milier. För det första kan en överdriven ansamling av hudceller på hudytan leda till att dessa celler blir instängda. Detta kan vara resultatet av skadad hud, antingen genom solbränna eller andra typer av hudirritationer som stör hudens naturliga exfolieringsprocess.</p>',
            extended_content: '<p class="p200 mt-xl">Förutom de fysiska orsakerna till milier, såsom skadad hud som leder till blockeringar i hudens förmåga att exfoliera sig själv, kan genetiska faktorer också spela en roll. Vissa människor kan vara mer benägna att utveckla milier på grund av deras hudtyp eller ärftliga faktorer som påverkar hur deras hud förnyar och exfolierar sig själv.</p>
