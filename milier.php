...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är milier?',
            content: '<p class="p200">Milier uppstår när keratin, ett protein som är en central beståndsdel i huden, fastnar under hudytan och bildar små, vita eller ibland gula cystor. Dessa små, hårda kapslar formar sig när döda hudceller inte kan avlägsnas på normalt sätt utan istället blir instängda inne i huden. Det finns flera faktorer som kan bidra till bildandet av milier. För det första kan en överdriven ansamling av hudceller på hudytan leda till att dessa celler blir instängda. Detta kan vara resultatet av skadad hud, antingen genom solbränna, blåsor, eller andra typer av hudirritationer som stör hudens naturliga exfolieringsprocess.</p>',
            extended_content: '<p class="p200 mt-xl">Förutom de mekaniska orsakerna till milier, såsom skadad hud som leder till blockeringar i hudens förmåga att exfoliera sig själv, kan genetiska faktorer också spela en roll. Vissa människor kan vara mer benägna att utveckla milier på grund av deras hudtyp eller ärftliga faktorer som påverkar hur deras hud förnyar och exfolierar sig själv.</p>
            <p class="p200 mt-xl">Även om milier kan uppstå hos personer i alla åldrar, ses de ofta hos nyfödda där de betraktas som helt normala och ofarliga. Hos vuxna kan milier ibland associeras med hudvårdsprodukter eller kosmetika som är för tjocka eller oljiga, vilket kan bidra till blockering av porer och den efterföljande bildningen av milier. Det finns också vissa hudtillstånd, som till exempel långvarig exponering för solen eller hudskador, som kan öka risken för att utveckla milier genom att påverka hudens naturliga avstötningsprocess.</p>
            <p class="p200 mt-xl">I sammanfattning är milier små cystor under huden som bildas på grund av ackumulering av keratin och döda hudceller. Faktorer som bidrar till deras bildning inkluderar skador på huden, användning av vissa hudprodukter, genetiska predispositioner, och i vissa fall, hudtillstånd som påverkar hudens förmåga att naturligt exfoliera sig själv. Trots att de är helt ofarliga, kan milier vara kosmetiskt störande för vissa, vilket leder till efterfrågan på behandlingar för att ta bort dem.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            title: 'får man milier?',
            content: '<p class="p200">Milier, även kända som milia i plural, är små, vita eller gulaktiga cystor som syns på hudytan. Dessa cystor är faktiskt små kapslar fyllda med keratin, ett protein som är en grundläggande komponent i hud, hår och naglar. Keratinet blir instängt under huden och bildar dessa distinkta, fasta kapslar som kan vara från någon millimeter upp till några millimeter i diameter.</p>',
