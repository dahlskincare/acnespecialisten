...
$trivias = array(
      ...
      new ProblemTrivia(
            prefix: 'Vem',
            title: 'får milier?',
            content: '<p class="p200">Milier är universella och kan påverka människor från alla åldersgrupper och hudtyper, men vissa grupper är mer benägna att få dem än andra. Nyfödda är särskilt benägna att utveckla milier, vilket reflekterar en naturlig del av hudens utveckling, där dessa vanligtvis försvinner av sig själva efter några veckor. Hos vuxna kan dock förekomsten av milier indikera behovet av att justera hudvårdsvanor eller adressera specifika hudproblem.</p>',
            extended_content: '<p class="p200 mt-xl">Individer med torr hud eller de som använder olämpliga hudvårdsprodukter som kan täppa till porerna löper en större risk att utveckla milier. Dessutom kan personer som har en genetisk benägenhet eller som har genomgått vissa typer av hudskador eller inflammatoriska tillstånd även finna sig mer benägna till dessa små cystor. En noggrann bedömning av ens hudvårdsvanor och eventuella genetiska predispositioner kan vara hjälpsam för att identifiera och minska risken för milier.</p>',
            icons: array('man-kvinna' => 'Män & Kvinnor', 'barn' => 'Barn', 'vuxna' => 'Vuxna', '65+' => 'Äldre')
      ),
      new ProblemTrivia(
            prefix: 'Var',
            title: 'får man milier?',
            content: '<p class="p200">Milier kan uppträda på nästan vilken del av kroppen som helst där det finns hud, men de är mest vanliga i ansiktet, speciellt runt ögonen, på kinderna, och näsan. De kan också uppträda på kroppens andra områden såsom halsen, bröstet, och till och med på könsorganen. Placeringen av milier kan ibland ge en ledtråd till deras orsak; till exempel, milier som dyker upp runt ögonen kan ofta kopplas till användningen av för tjocka ögonkrämer eller vissa typer av smink som kan täppa till de små porerna i detta känsliga hudområde.</p>',
            extended_content: '<p class="p200 mt-xl">Förståelsen för var milier mest sannolikt uppstår kan leda till mer riktade förebyggande åtgärder, såsom att undvika tunga hudvårdsprodukter i benägna områden och att införa milda exfolieringsrutiner för att främja en hälsosam cellomsättning. Dessutom kan professionella hudvårdsbehandlingar som milda peelingar eller laserterapi bidra till att effektivt minska och förebygga milier genom att adressera de underliggande orsakerna till deras bildande.</p>',
