...
$trivias = array(
      ...
      new ProblemTrivia(
            prefix: 'Vem',
            title: 'får milier?',
            content: '<p class="p200">Milier är universella och kan påverka människor från alla åldersgrupper och hudtyper, men vissa grupper är mer predisponerade än andra. Nyfödda är särskilt benägna att utveckla milier, vilket reflekterar en naturlig del av hudens utveckling, där dessa vanligtvis försvinner av sig själva efter några veckor. Hos vuxna kan dock förekomsten av milier indikera behovet av att justera hudvårdsvanor eller adressera specifika hudproblem.</p>',
