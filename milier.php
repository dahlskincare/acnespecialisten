...
$trivias = array(
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Förutom de yttre orsakerna till milier, såsom skadad hud som leder till blockeringar i hudens förmåga att exfoliera sig själv, kan genetiska faktorer också spela en roll. Vissa människor kan vara mer benägna att utveckla milier på grund av deras hudtyp eller ärftliga faktorer som påverkar hur deras hud förnyar och exfolierar sig själv.</p>
