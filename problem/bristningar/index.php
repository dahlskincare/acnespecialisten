...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            content: '<p class="p200">Bristningar, även kända som striae eller stretchmarks, kan uppstå av flera olika anledningar, men de två vanligaste orsakerna är snabb tillväxt och snabb viktuppgång. När huden sträcks snabbt, som under puberteten, graviditet eller vid snabb viktuppgång, kan det leda till att det mellersta lagret av huden (dermis) rivs. Detta orsakar de synliga linjerna som vi känner till som bristningar. De kan variera i färg från rosa, rött till lila, och bleknar över tid till en mer hudliknande färg, även om de sällan försvinner helt.</p>',
            extended_content: '<p class="p200 mt-xl">Växande<br />Under puberteten kan ungdomar uppleva snabba tillväxtspurter som kan leda till bristningar, särskilt på platser som höfter, bröst, skinkor och lår. Dessa är ofta resultatet av den naturliga tillväxten och utvecklingen som sker under denna period.</p>
