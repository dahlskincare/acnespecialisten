...
$trivias = array(
      new ProblemTrivia(
            ...
            content: '<p class="p200">Bristningar, vetenskapligt benämnda som striae, är märkbara, ojämna linjer eller band på huden som uppstår när bindväv under huden tänjs ut över sin flexibilitetsgräns. Denna snabba tänjning, oftast över en kort tidsperiod, leder till en störning av huden där den har blivit tunnare och förlorat en del av sin elastiska förmåga. Denna förändring beror på skador i hudens kollagen och elastinfibrer, de proteiner som är ansvariga för hudens fasthet och elasticitet. När bristningar först uppträder kan de ofta ha en röd, blåaktig eller purpurlig nyans på grund av de brustna blodkärlen under huden. Med tiden läker dessa blodkärl, vilket gör att bristningarna gradvis övergår till att bli mer silverfärgade eller vitaktiga. Men förutom den rena färgförändringen kan ytan av bristningarna vara något räfflad eller gropig, vilket skiljer dem från den omgivande huden.</p>',
            extended_content: '<p class="p200 mt-xl">Mikroskopiskt sett kan man se att bristningar inte bara är ytliga skador. De är faktiskt små ärrbildningar i dermis, det mellersta skiktet av huden. Denna störning av kollagenproduktionen orsakar också en förtunning av epidermis, det yttersta hudlagret. Forskare har även funnit att kortisol, ett hormon som kroppen producerar vid stress, kan försvaga elastiska fibrer i huden, vilket kan göra det lättare för bristningar att utvecklas.</p>
            <p class="p200 mt-xl">Bristningars utseende och utveckling kan variera beroende på enskilda genetiska faktorer, hudtyp och även beroende på var på kroppen de uppträder. Medan moderna behandlingsmetoder kan minska deras synlighet, finns det för närvarande ingen fullständig botemedel mot bristningar. Det bästa tillvägagångssättet är att förebygga dem genom att bibehålla en hälsosam vikt, näring och hudvård.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            ...
            <p class="p200 mt-xl">Genetiska faktorer spelar också en roll. Om dina föräldrar eller syskon har bristningar, kan det öka din risk att utveckla dem, vilket tyder på att det finns en genetisk komponent i hur mottaglig ens hud är för att utveckla bristningar. Det finns även vissa sjukdomar, som Marfans syndrom och Cushings syndrom, som kan påverka hudens elasticitet och därmed öka risken för bristningar. Slutligen kan användning av vissa mediciner, särskilt de som påverkar hormonnivåerna eller som försvagar huden, öka risken för bristningar. Exempel på detta är vissa steroidkrämer eller långvarig användning av orala kortikosteroider. Förståelsen av de faktorer som bidrar till bristningar kan hjälpa individer att förebygga dem eller i alla fall minska deras svårighetsgrad. Medan de inte kan förhindras helt, finns det metoder och behandlingar som kan göra dem mindre märkbara.</p>',
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Det bör noteras att även om bristningar oftast associeras med kvinnor, på grund av graviditet och andra hormonella förändringar, är män absolut inte immuna. Som tidigare nämnts kan snabb muskeltillväxt, användning av anabola steroider och vissa medicinska tillstånd alla bidra till bristningar hos män. Till sist, oavsett var på kroppen de uppträder, är det viktigt att förstå att bristningar är en naturlig del av hudens respons på snabb sträckning. De kan blekna över tid, men de representerar ingen hälsorisk och är ofta bara en estetisk bekymmer för den drabbade.</p>',
