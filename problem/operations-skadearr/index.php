...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Platsen för skadan eller traumat på kroppen kan påverka ärrbildningen. Vissa områden, som bröstet eller ryggen, har en tendens att bilda tjockare och mer framträdande ärr, medan andra områden, som ansiktet, ofta läker med mindre synliga ärr. Till sist kan faktorer som den initiala skadans svårighetsgrad, typen av skada eller komplikationer under läkningsprocessen såsom infektion och enskilda hälsoförhållanden alla påverka ärrbildningsprocessen. Det är viktigt att notera att även om vissa personer kan vara mer benägna att utveckla distinkta eller framträdande ärr än andra, har ingen individ helt immunitet mot ärrbildning, eftersom det är kroppens naturliga sätt att läka efter en skada.</p>',
