...
$trivias = array(
      ...
      new ProblemTrivia(
            prefix: 'Vem',
            title: 'får ärr?',
            content: '<p class="p200">Ärrbildning är något som kan drabba alla efter en skada eller operation på huden. Dock påverkas omfattningen och typen av ärrbildning av flera olika faktorer. Ålder spelar en viktig roll i hur vår hud läker. Barns och ungdomars hud har en tendens att läka snabbare och kan ibland bilda tjockare ärr än hos vuxna eftersom de har en högre kollagenproduktion. Äldre individer kan däremot uppleva en långsammare läkningsprocess på grund av minskad kollagenproduktion och hudelasticitet, vilket kan resultera i tunnare och plattare ärr.</p>',
