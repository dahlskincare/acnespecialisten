...
$seo_title = 'Vad är operations- och skadeärr? - Symptom, orsak och behandling';
...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Platsen för skadan eller traumat på kroppen kan påverka ärrbildningen. Vissa områden, som bröstet eller ryggen, har en tendens att bilda tjockare och mer framträdande ärr, medan andra områden, som ansiktet, ofta läker med mindre synliga ärr. Till sist kan faktorer som den initiala skadans svårighetsgrad, typen av skada (brännskada, skärsår, skrapsår), infektioner eller komplikationer under läkningsprocessen och enskilda hälsoförhållanden alla påverka ärrbildningsprocessen. Det är viktigt att notera att även om vissa personer kan vara mer benägna att utveckla distinkta eller framträdande ärr än andra, har ingen individ helt immunitet mot ärrbildning, eftersom det är kroppens naturliga sätt att läka efter en skada.</p>',
      ...
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Brännskador ger en annan typ av ärrbildning. De kan resultera i tjocka, strama ärr, kallade kontrakturer, som kan begränsa rörligheten. Platsen för brännskadan kommer att påverka typen och utseendet på ärret. Även om stretchmärken tekniskt sett inte räknas som ärr, relateras de till ärrbildning eftersom de uppstår från en snabb utsträckning av huden, vilket kan ske på platser som buken, låren, höfterna eller brösten.</p>
