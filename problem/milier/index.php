...
$consultation_url = "consultation-booking?problem=milier";
$consultation_url_title = "Gratis Konsultation för Milier";

$booking_url_label = "Boka behandling";
$booking_url = "treatment-booking?problem=milier";
...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är milier?',
            content: '<p class="p200">Milier är små, fasta cystor som är vanligtvis vita eller hudfärgade och som kan förekomma på olika delar av huden. De är typiskt sett 1-2 millimeter i diameter och uppstår när döda hudceller eller keratin, ett protein som naturligt förekommer i hud, hår och naglar, blir instängda under hudens ytskikt. Denna instängning skapar en liten kapsel eller ficka fylld med proteinet keratin. Milier är i allmänhet helt smärtfria och orsakar inte inflammation eller rodnad runt det drabbade området, vilket gör dem olika från akne eller andra mer inflammerade hudåkommor.</p>',
            extended_content: '<p class="p200 mt-xl">Många förväxlar milier med vanlig akne, men dessa två hudåkommor skiljer sig åt både i deras orsaker och i hur de bör behandlas. Till skillnad från akne, är milier inte fyllda med pus och de är inte resultatet av bakterieinfektioner eller inflammation. De är heller inte associerade med överproduktion av talg, vilket är en av de vanligaste orsakerna till akne. Det är därför viktigt att inte klämma på milier i ett försök att "rensa ut" dem, eftersom detta kan leda till infektion och ärrbildning. Milier är heller inte nödvändigtvis relaterade till dålig hygien, och det faktum att de förekommer hos nyfödda visar att de kan påverka även de med den mest "oskyldiga" av hud.</p>
            <p class="p200 mt-xl">Milier klassificeras ofta i två huvudkategorier: primära och sekundära. Primära milier uppstår av okända anledningar och är mer vanliga hos nyfödda och små barn. Sekundära milier uppstår ofta som ett resultat av en hudskada eller en hudåkomma, som till exempel brännskador eller långvarig användning av steroidkrämer. De kan också vara en biverkning av vissa kosmetiska procedurer som dermabrasion eller laserbehandlingar. Det är viktigt att känna till dessa kategorier för att bättre förstå hur man ska hantera och behandla milier.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            title: 'får man milier?',
            content: '<p class="p200">Orsakerna till att man får milier kan vara många och varierar från person till person. Generellt sett uppstår milier när döda hudceller eller keratin blir instängda under hudens ytskikt. Detta kan hända av olika anledningar, inklusive naturliga hudförändringar, hormonella fluktuationer, eller som en reaktion på vissa hudprodukter. Men det finns andra faktorer som kan spela in, såsom ålder, hudtyp och även genetiska predispositioner. För det första, ålder har en betydande inverkan. Medan milier är vanliga hos nyfödda, kan de även förekomma i vuxen ålder, ofta som ett resultat av förändringar i huden eller hormonella obalanser. Exempelvis kan kvinnor uppleva en ökning av milier under graviditet eller menopaus på grund av hormonella förändringar.</p>',
            extended_content: '<p class="p200 mt-xl">För det andra kan livsstilsval och externa faktorer påverka sannolikheten för att utveckla milier. Personer som utsätter sin hud för mycket sol, eller som använder oljebaserade eller tunga hudvårdsprodukter, löper högre risk att få milier. Användningen av vissa mediciner, inklusive steroidkrämer och andra topikala behandlingar, kan också bidra till uppkomsten av milier. För det tredje kan vissa hudåkommor och medicinska tillstånd öka risken för att utveckla milier. Dessa inkluderar saker som brännskador, allergiska reaktioner och även vissa typer av hudsjukdomar. Det har också observerats att personer med mer fuktig och oljig hud är mer benägna att utveckla milier.</p>
            <p class="p200 mt-xl">Slutligen är det värt att nämna att även om det är relativt oklart varför vissa personer är mer benägna att utveckla milier än andra, så är genetiska faktorer troligtvis också inblandade. Detta innebär att om andra i din familj har haft milier, kan det öka din egen risk att utveckla dem. Det är alltså en kombination av genetiska, hormonella och externa faktorer som samverkar för att orsaka dessa små, men ofta störande, hudcystor.</p>',
