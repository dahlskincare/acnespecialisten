...
$services = array(
    new Service(
        ...
        image_alt: 'Bild på ansiktsbehandling mot akne',
        ...
        consultation_url_title: 'Boka hudkonsultation för akne',
    ...
    new Service(
        ...
        booking_url_label: 'Boka behandling',
        booking_url_title: 'Boka laserbehandling mot akne',
    ...
    new Service(
        ...
        consultation_url_title: 'Boka konsultation för akne',
        booking_url: 'Boka behandling',
        booking_url_label: 'Boka behandling',
