...
$trivias = array(
      ...
      new ProblemTrivia(
            prefix: 'Var',
            title: 'får man stora porer?',
            content: '<p class="p200">Stora porer, även kallade förstorade eller vidgade porer, kan dyka upp på olika delar av kroppen, men de är mest framträdande och märkbara i ansiktet. Låt oss utforska var de oftast förekommer och varför. Näsan är ett av de mest framträdande områdena där förstorade porer kan observeras. Eftersom näsan naturligt producerar en högre mängd talg än andra delar av ansiktet, kan porerna där lätt bli tilltäppta och därmed framstå som större. Pannan är ett annat område där stora porer kan bli särskilt märkbara. Detta beror på pannans närhet till T-zonen, ett område på ansiktet som har en högre koncentration av talgkörtlar. Denna överdrivna talgproduktion kan leda till förstorade porer, särskilt om döda hudceller byggs upp och inte regelbundet exfolieras bort.</p>',
