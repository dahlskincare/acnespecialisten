...
$trivias = array(
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Pormaskar är en mycket vanlig hudåkomma, och trots att de kan vara irriterande och estetiskt störande är de i allmänhet inte skadliga för huden. Det är dock viktigt att inte klämma pormaskar, eftersom detta kan leda till hudskador, ärrbildning och eventuell försämring av akne.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
