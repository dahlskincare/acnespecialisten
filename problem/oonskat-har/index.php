...
$articles = array(
      new Article(
            ...
            content: '<p class="p200">Att hantera oönskat hår kan vara en utmaning som påverkar självkänslan negativt. Många förlitar sig på tillfälliga lösningar som rakning eller vaxning, vilka ofta leder till återkommande besvär och hudirritation. För de som söker en mer långvarig lösning på problemet med oönskad hårväxt, erbjuder professionella behandlingar som laserhårborttagning en effektiv metod. Denna teknik skadar hårfolliklarna med ljusenergi, vilket minskar hårets återväxt och kan ge bestående resultat med färre biverkningar.</p>
