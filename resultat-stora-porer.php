...
$results_images = [
    ...
    new LabelImage(image_url: '/bilder/resultat/832x476/pormaskar/pormaskar-resultat-fore-efter-mycket-ansikte.webp', image_alt: 'Mycket stora porer i ansiktet före och efter behandling', image_title: 'Stora porer resultat', content: ''),
    ...
    <main>
        ...
        <div class="container">
            ...
            <section id="cta-banner" class="large-margin">
                ...
                <div>
                    <a href="https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Large_Pores" class="button white expand l10n" title="Boka en gratis hudkonsultation">Boka en gratis hudkonsultation</a>
                </div>
            </section>
