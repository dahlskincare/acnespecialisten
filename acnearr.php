...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är acneärr?',
            content: '<p class="p200">Acneärr representerar permanenta förändringar i hudens struktur som följer efter läkningen av akne, och dessa ärr tar sig uttryck på olika sätt, påverkande hudens textur samt dess färgton. En djupare förståelse för de olika typerna av acneärr är central för att kunna anpassa och effektivisera behandlingsmetoder.</p>',
