...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            content: '<p class="p200">Acneärr bildas som ett resultat av långvarig skada på huden orsakad av obehandlad akne. Dessa ärr uppstår när aknens innehåll, som innefattar aggressiva fettsyror, angriper och gradvis bryter ned hudvävnaden. Denna process kan leda till ärr som varierar i form, storlek och djup. Inledningsvis skapas en missfärgning, denna mörka fläck i huden finns kvar efter att finnen försvunnit. Om problemet pågår under en längre period, kan hudstrukturen skadas och leda till gropar. Vidare kan allvarlig akne som cystor och noduler tränga djupt in i huden och orsaka skador på vävnaden nedanför, vilket leder till ärrbildning.</p>',
            extended_content: '<p class="p200 mt-xl">För mycket eller för lite kollagen på skadestället kan leda till upphöjda ärr eller gropar i huden. Felaktig hantering av akne, såsom att peta och klämma på aknen, kan också förvärra ärrbildningen, och felaktig behandling kan leda till permanenta märken och fläckar. Förebyggande åtgärder, som tidig behandling av akne och rätt hudvård, kan minska risken för ärrbildning.</p>
            <p class="p200 mt-xl">På Acnespecialisten fokuserar vi på att förstå ditt unika tillstånd och behov. Med 30 års erfarenhet och med de bästa metoderna för att behandla acneärr, arbetar vi med att minska och förhindra permanenta märken på din hud. Att ta första steget med en kostnadsfri acneärr konsultation hos oss kan vara starten på din väg till en sund och klar hud.</p>',
            icons: array()
      ),
