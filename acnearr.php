...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            content: '<p class="p200">Acneärr bildas som ett resultat av långvarig skada på huden orsakad av obehandlad akne. Dessa ärr uppstår när aknens innehåll, som innefattar aggressiva fettsyror, angriper och gradvis bryter ned hudvävnaden. Denna process kan leda till ärr som varierar i form, storlek, djup och färg. Inledningsvis skapas en missfärgning, denna mörka fläck i huden finns kvar efter att finnen försvunnit. Om problemet pågår under en längre period, kan hudstrukturen skadas och leda till gropar. Vidare kan allvarlig akne som cystor och noduler tränga djupt in i huden och orsaka skador på vävnaden nedanför, vilket leder till ärrbildning.</p>',
