...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_AcneScars', 'Boka gratis konsultation för acneärr'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=laserProblem&skipable_problem=Problem_AcneScars', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_AcneScars', 'Boka gratis konsultation för acneärr'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=laserProblem&skipable_problem=Problem_AcneScars', 'Boka denna behandling'),
      ],
...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Detta sker ofta på grund av svårare obehandlad akne, som pustler, cystor och noduler, som skadar huden djupare och mer omfattande än mindre finnar. När dessa akneformer läker, lämnar de bakom sig fördjupningar i huden eftersom det inte finns tillräckligt med kollagen (ett protein som hjälper till att hålla huden jämn och elastisk) för att fylla ut skadan. Detta resulterar i att huden får ett gropigt utseende.</p>
            <p class="p200 mt-xl">Postinflammatoriska hyperpigmenteringar uppstår däremot när huden överproducerar melanin, pigmentet som ger huden dess färg, som svar på inflammation. Denna överproduktion kan leda till att områden av huden blir mörkare än omgivningen. Dessa mörka fläckar kan uppstå efter nästan vilken typ av acne som helst, inklusive de fall där aggressiva fettsyror har frätit på huden. Även om dessa fläckar kan blekna med tiden, kan de vara envisa och kräver ibland speciella behandlingar för att få bort.</p>
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Ålder och hudtyp är ytterligare faktorer som påverkar vem som får acneärr. Ungdomar och unga vuxna genomgår hormonella förändringar som ofta leder till mer utbredd acne, vilket kan öka risken för ärrbildning om acnen inte hanteras i tid. Personer med oljig hudtyper kan också ha en ökad benägenhet för acne, vilket i sin tur kan leda till en högre risk för ärr.</p>
            <p class="p200 mt-xl">Slutligen är det viktigt att nämna att personer som har en tendens att peta, pilla eller klämma sina finnar löper en större risk att utveckla ärr. Denna mekaniska manipulation kan förvärra hudens inflammation och skada, vilket leder till en större sannolikhet för ärrbildning. Att motstå frestelsen att röra vid finnar och följa en lämplig hudvårdsrutin är avgörande för att minska risken för acneärr.</p>
            <p class="p200 mt-xl">Sammanfattningsvis är personer med genetiska förutsättningar, de som genomgår hormonella förändringar, har en oljig hudtyp, eller de som aktivt pillar sina finnar, mer benägna att utveckla acneärr. Förståelsen för dessa riskfaktorer är viktig för att vidta åtgärder mot att förhindra ärrbildning och hantera acnen på ett effektivt sätt.</p>',
...
$treatment_steps = array(
      new TreatmentStep(
            ...
            url: 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_AcneScars',
      ...
      new TreatmentStep(
            ...
            url: 'https://www.acnespecialisten.se/book?flow=problem&problem=Problem_AcneScars',
...
$symptoms = array(
      ...
      new Symptom(
            ...
            content: 'Breda fyrkantiga med skarpa kanter och fördjupningar som liknar formen på ett box. De bildas vanligtvis efter akneutbrott som lämnar runda eller ovala hål i huden.',
            url: 'atrofiska-arr.php',
      ...
      new Symptom(
            ...
            aka: 'Gropar',
            content: 'Vågig yta med mjuka, ojämna fördjupningar. De orsakas av skador under huden som drar huden nedåt, vilket skapar ett oregelbundet utseende som en månkrater',
            url: 'atrofiska-arr.php',
      ...
      new Symptom(
            ...
            content: 'Rosa, Röda till lila fläckar på huden efter en inflammation. Detta behöver inte vara en permanent pigmentförändring utan en tillfällig rodnad som orsakas av skadade eller vidgade blodkärl under hudens yta.',
            url: 'postinflammatorisk-hyperpigmentering.php',
...
$services = array(
      new Service(
            ...
            booking_url: 'https://www.acnespecialisten.se/book?flow=laserProblem&skipable_problem=Problem_AcneScars',
...
$articles = array(
      new Article(
            ...
            content: '<p class="p200">Vi erbjuder de senaste behandlingsmetoderna mot alla typer av acneärr. Oavsett om det gäller laserbehandling för de mest envisa ärrtyperna, microneedling som är effektiv mot atrofiska ärr, eller kemisk peeling för ärrtypen fläckar, är våra behandlingsalternativ bäst mot acneärr.</p>
            <p class="p200 mt-m">Din resa med oss börjar med en kostnadsfri konsultation. Vi tar oss tiden att analysera ditt unika fall och erbjuder dig en personlig hudterapeut. Din terapeut kommer att vara din guide och stöttepelare från start till mål, och skapa en behandlingsplan som är helt anpassad efter dina behov.</p>',
      ),
      new Article(
