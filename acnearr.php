...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är acneärr?',
            content: '<p class="p200">Acneärr uppstår när obehandlad akne skadar huden under en längre tid. Orsaken till detta är att aknens innehåll består av en aggresiv fettsyra som fräter på huden vilket skadar hudens vävnad. Det kan variera i form och storlek och påverka både utseendet och känslan på huden.</p>',
