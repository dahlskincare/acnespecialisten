...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Acne', 'Boka gratis konsultation'),
            new Link('Boka behandling', 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Acne', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Acne', 'Boka gratis konsultation'),
            new Link('Boka behandling', 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Acne', 'Boka denna behandling'),
      ],
...
<p class="p200 mt-m">Sammanfattningsvis kräver hantering av vuxenacne en kombination av lämplig hudvård och behandling. Genom att använda en heltäckande behandlingsplan och följa en noggrann hudvårdsrutin kan individer med vuxenacne uppnå betydande förbättringar i sitt hudtillstånd.</p>';
...
$treatment_steps = array(
      ...
      new TreatmentStep(
            ...
            url: 'https://www.dahlskincare.com/sv/hudvardsprodukter/akne/',
...
$results_images = array(
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - käklinje',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - kinder och haka',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - kinder och mun',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - inflammerad finne',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - inflammerad hy',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - utbredd akne',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - röda märken',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - hela ansiktet',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - kind',
            content: '',
      ),
      new LabelImage(
            ...
            image_title: 'Vuxenacne resultat - svår kind',
            content: '',
      ),
);
...
<head>
      ...
      <link rel="canonical" href="https://www.acnespecialisten.se/vuxenacne.php" />
      ...
      <main>
            ...
            <div class="container">
                  <div id="content">
                        ...
                        <section id="results">
                              <?php
                              $results_title = 'Resultat för vuxenacne';
