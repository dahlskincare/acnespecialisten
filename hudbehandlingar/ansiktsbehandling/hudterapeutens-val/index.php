...
$big_types = array(
    'process' => new Service(
        ...
        duration: '70 min',
        price: null,
        content: '<p class="p200">Din ansiktsbehandling börjar med en rengöring samtidigt som hudterapeuten går igenom din huds unika behov och behandlingsmöjligheter. Beroende på din huds tillstånd och behov kan vi välja att integrera en mild exfoliering eller andra skräddarsydda metoder som syftar till att förbättra hudens struktur och lyster.</p>
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering inom hudvårdsbehandlingar',
        image_title: 'Cazzandra L - Expert på hudvårdsbehandlingar'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med omfattande kunskap inom hudvårdsbehandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på hudvårdsbehandlingar'
    ),
    new Specialist(
        name: 'Vilma Libom',
