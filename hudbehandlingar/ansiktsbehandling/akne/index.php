...
$model = new Service(
    ...
    procedures: array(
        ...
        new Procedure(
            ...
            booking_url: 'https://boka.acnespecialisten.se?flow=facialProblem&problem=Problem_Acne&area=Facial_Face&procedures=PriceClass_2_Procedure_3',
            booking_url_label: 'Boka tid för behandling',
            booking_url_title: 'Boka tid för behandling'
        ),
        new Procedure(
            ...
            booking_url: 'https://boka.acnespecialisten.se?flow=facialProblem&problem=Problem_Acne&area=Facial_Face&procedures=PriceClass_2_Procedure_5',
            booking_url_label: 'Boka tid för behandling',
            booking_url_title: 'Boka tid för behandling'
        )
    ),
