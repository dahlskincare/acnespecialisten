...
$treatment_areas_text = '<p class="p200">Välj din klinik för att se tillgängliga behandlingar.</p>';
$treatment_areas = array(
    new TreatmentArea(
        ...
        title: 'Sundbyberg',
        description: '<p class="p200">Alla injektionsbehandlingar på vår Sundbybergsklinik.</p>',
        items: array(
    ...
    new TreatmentArea(
        ...
        title: 'Östermalm',
        description: '<p class="p200">Alla injektionsbehandlingar på vår Östermalm-klinik.</p>',
        items: array(
            new TreatmentAreaItem(
                image: '/icons/1x.svg',
                image_alt: '1x område',
