...
$service_categories = array(
    new ServiceCategory(
        ...
        image_large: '/bilder/hudbehandlingar/424x324/konsultation.webp',
        ...
        booking_url_title: 'Boka elevbehandling',
    ...
    new ServiceCategory(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=problem',
...
<body>
    ...
    <main>
        <section id="banner">
            <?php
            include($_SERVER['DOCUMENT_ROOT'] . '/includes/widgets/green_header_banner/hudbehandlingar_green_header_banner.php');
            ?>
            <div class="container">
                <div id="treatments">
