...
$green_banner_content = new GreenBannerContent(
    ...
    description: 'Vi erbjuder ett brett utbud av hudbehandlingar anpassade för alla typer av hudproblem. Våra tjänster inkluderar ansiktsbehandlingar som djuprengör huden och porer och återupplivar huden, avancerade kemiska peelingar för hudföryngring, och laser hudbehandling för att effektivt behandla olika hudtillstånd.',
