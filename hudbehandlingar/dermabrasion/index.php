    ...
    new Service(
        ...
        procedures: array(
            new Procedure(
                ...
                price: '1995 kr',
                savings: null,
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_4_Procedure_1'
            ),
            new Procedure(
                label: '3 behandlingar',
                price: '4995 kr',
                savings: 'Spara 990 kr',
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_4_Procedure_3'
            ),
            new Procedure(
                label: '5 behandlingar',
                price: '7995 kr',
                savings: 'Spara 1980 kr',
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_4_Procedure_5'
            )
        )
    ),
);
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i dermabrasion',
        image_title: 'Cazzandra L - Expert på dermabrasion'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom dermabrasion',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på dermabrasion'
    ),
    new Specialist(
        name: 'Vilma Libom',
