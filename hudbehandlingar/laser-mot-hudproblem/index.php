...
$specialists = array(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom laserbehandling av hudproblem',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på laserbehandling av hudproblem'
    ),
    new Specialist(
        name: 'Vilma Libom',
