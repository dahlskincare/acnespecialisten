...
**MEDEL-modellen träffar 6/6 nya** (microderm 1,82→🟠 ✓ · bristningar 1,92→🟠 ✓ · rhinophyma 2,06→🟠 ✓ · solskadad 2,09→🟠 ✓ · pigmentflackar 2,06→🟠 ✓ · oonskat-har 1,77→🟠 ✓); **MEDIAN missar 2** (solskadad 🔴 ✗, rhinophyma gränsfall→🔴 ✗). Löpande: **medel 11/11** på sidor med kända block-counts (micro 1,44🔵 · porto 1,00🔵 · acne-rygg 1,38🔵 · sebo 1,25🔵 · mogen-hy 1,57🟠 · + de 6 nya), **median 14/17**. **Avrundningsregeln preciserad av nya datan:** "avrunda mot värre" = STANDARDAVRUNDNING där exakt ,5 rundar uppåt — 2,06/2,09 rundar NED till 🟠 (tak-tolkning/ceiling hade gett 🔴 ✗✗). Kvar: räkna om de 6 äldre valideringssidorna (§9-TODO). **Sekundärt mönster (nu ≥3 sidor):** korta behandlingskort avgörs av ÖPPNINGEN — mekanism-öppning 🔵 (pigment-laser, oonskat-laser) vs marknads-öppning 🔴 (pigment-kemisk/micro, acne-laser) — redan kodifierat i §1.3 regel 2; "konkreta vi-handlingar"-konsultblocket = 🔵 på 4 sidor (rhinophyma/bristningar/pigmentflackar/oonskat-har).
