...
## §1.4-KONSOLIDERING efter 2 jul em-leveransen (4 nya MODERATE-facit)
**MEDEL-modellen träffar 4/4 nya** (microderm 1,82→🟠 ✓ · bristningar 1,92→🟠 ✓ · rhinophyma 2,06→🟠 ✓ · solskadad 2,09→🟠 ✓); **MEDIAN missar 2 av 4** (solskadad 🔴 ✗, rhinophyma gränsfall→🔴 ✗). Löpande: **medel 9/9** på sidor med kända block-counts (micro 1,44🔵 · porto 1,00🔵 · acne-rygg 1,38🔵 · sebo 1,25🔵 · mogen-hy 1,57🟠 · + de 4 nya), **median 12/15**. **Avrundningsregeln preciserad av nya datan:** "avrunda mot värre" = STANDARDAVRUNDNING där exakt ,5 rundar uppåt — 2,06/2,09 rundar NED till 🟠 (tak-tolkning/ceiling hade gett 🔴 ✗✗). Kvar: räkna om de 6 äldre valideringssidorna (§9-TODO).
