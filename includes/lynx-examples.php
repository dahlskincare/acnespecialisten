...
## /mogen-hy.php — facit 22 Apr 2026, mottaget 2 jul (MODERATE-vågen §8, EJ omskriven — FÖRE-facit; ⚠️ MÖJLIGEN TRUNKERAT — skärmdumparna slutar vid FAQ-titeln "Varför får man rynkor när man blir äldre?" utan badge, block därunder saknas)
| Block (snippet) | Betyg | Varför (tolkning) |
|---|---|---|
...
**Median-check (§1.4) — ⚠️ FÖRSTA möjliga mismatchen, PRELIMINÄR:** synliga betygsatta block 5🔴/1🟠/5🔵/3🟢 (n=14) → median 🔵 = SLIGHT, men Pages-listan säger 🟠 MODERATE. **Döm INTE §1.4 på detta än** — facitet är troligen trunkerat (block under "Varför får man rynkor…" saknas); ~2–4 fler 🔴/🟠-block därunder skulle ge median 🟠 ✓. **TODO: be ägaren om resten av blocklistan innan §1.4-statistiken uppdateras.** **Obetygsatt:** "Även känt som Åldrande hy Ålderstecken" (alias), rubrikerna "Äldre"/"Händer", "Från 5595 kr", FAQ-titlarna "Vad menas med termen…", "Vid vilken ålder…", "Hur påverkar hormonella…", "Vilken roll spelar genetik…", "Varför får man rynkor…". **Rewrite-ammo:** 2 grammatikfel live ("en genetiska anlag", "din åldrande") + 2 typos ("elasticitet.Hos", "huvårdsmål"); 🔴-blocken = långa definitioner/orsaksprosa med scaffolding-öppningar och fluff-svansar — mekanikinnehållet (kollagen, talg, platser) finns redan och kan bäras över i tätare form.
