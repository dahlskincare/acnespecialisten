...
**MODERATE-vågen:** ✅ KLARA: `om-oss.php`, `hudbehandlingar/ipl/`, `ipl-rosacea.php` (alla LIVE, väntar refresh), `mogen-hy.php` (omskriven 2 jul → staging), `hudproblem/oonskat-har/` (omskriven 3 jul → staging). **KVAR (5) — facit komplett för alla:** `pigmentflackar.php` **(FACIT ✅ 2 jul 14:22: 8🔴/4🟠/5🔵/1🟢, KW244 — 3 typos fixade 2 jul)**, `rhinophyma-rosacea.php` **(FACIT ✅ 2 jul em: 8🔴/2🟠/5🔵/1🟢 — 2 språkfel fixade 2 jul)**, `microdermabrasion.php` **(FACIT ✅ 2 jul em: 5🔴/1🟠/3🔵/2🟢)**, `solskadad-hy.php` **(FACIT ✅ 2 jul em: 6🔴/1🟠/3🔵/1🟢)**, `hudproblem/bristningar/` **(FACIT ✅ 2 jul em: 6🔴/1🟠/5🔵/1🟢)**. Alla facit i `lynx-examples.php`. (Prioordning: §9.1.)
...
- [ ] `microdermabrasion.php` (1,82 → ≈2 fixar; AIQ GOOD→OK-bevakning — be om frågedetalj vid start; inga språkfel)
...
| Sida | Status | Tid |
|------|--------|-----|
| `microdermabrasion.php` | de-AI-rewrite pågår (facit-guidad: 5🔴+1🟠; AIQ GOOD→OK-bevakning — frågedetalj saknas, be ägaren) | 2026-07-03 |
