...
| microdermabrasion.php | 2026-07-03 | *(väntar main-push)* | 🟠 MODERATE, SCORE 50 färsk, AIQ OK (GOOD→OK-tråden öppen, frågedetalj saknas); per-block-facit 25 jun (5🔴/1🟠/3🔵/2🟢, medel 1,82) | 6 omskrivna block → 🔵-band; block-medel →~1,0 → **sidnivå 🟠→🔵**; AI STYLE ↑, Language ↑ (kongruens/anglicismer), Evidence =, Depth/sökord = | – | omskriven + §7.4b-verifierad (3 agenter) → staging 3 jul (verifierad 200 + ny fras); kortpriser rättade 3 jul em; **väntar main-push → LYNX-refresh** |
...
| Sida | Status | Tid |
|------|--------|-----|
| *(ingen pågående — klart för idag 3 jul: oonskat-har + microdermabrasion → staging. Nästa sida = `hudproblem/bristningar/` — ägarbeslut krävs om de två nära-identiska definitionsblocken, §13.D)* | | |
