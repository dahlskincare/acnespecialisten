...
- [ ] **[medel] "Från 799 kr" i hero på FYRA sidor: akne- + rosacea-undersidorna (`hudbehandlingar/ansiktsbehandling/`) + `porrengoring.php` + `djuprengoring.php` (ägarbesked 10 juli: "den ska vi kika på sen")** — matchar ingen rad i bokningssystemets prislista (10 juli-skärmbilden) och ingen av sidornas egna paketrader (allt börjar på 1595 kr) ⇒ trolig kvarleva från kampanj/borttagen minivariant — **förslag:** ägaren verifierar mot bokningssystemet; rättas i så fall enligt hudterapeutens-val-mönstret (herotext + ev. PriceClass i boknings-URL:er, logg #62).
