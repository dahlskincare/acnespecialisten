...
- [ ] **[medel] "Från 799 kr" i hero på akne- och rosacea-undersidorna (`hudbehandlingar/ansiktsbehandling/`)** — matchar ingen rad i bokningssystemets prislista (10 juli-skärmbilden; deras styckpriser 1595 kr = Problemhy-klassen stämmer, paketpriserna 3495/4995 syns inte i bilden) — **förslag:** ägaren verifierar mot bokningssystemet om 799 är gammal kampanj eller medvetet intropris; rättas i så fall enligt hudterapeutens-val-mönstret (text + PriceClass i boknings-URL:er, logg #62).
