...
| Sida | Status | Tid |
|------|--------|-----|
| **`microneedling.php`** — Fas 3b de-AI enligt REWRITE-SPEC (`lynx-examples`); facit 22 april 2026 | pågående | 8 juli |
...
- [ ] **🎯 FYRA SIDOR UT UR MODERATE (dump 8 juli 10:45) — BESTÄLL SLIGHT-RADERNA.** `mogen-hy` · `solskadad-hy` · `rhinophyma-rosacea` · `pigmentflackar` saknas i MODERATE-gruppen; den består nu av 5 rader (ipl/bristningar/oonskat-har/ipl-rosacea/microdermabrasion). Vyn är sorterad på AI COPY, så gruppen är komplett — men **skuren efter `/acnebehandling.php`**, så vi ser dem inte i SLIGHT. **Frånvaro ≠ SLIGHT:** pigmentflackar försvann ur samma vy 6 juli under pågående omanalys (logg #14). **Attribuera inget** förrän raderna är sedda (mätregel 4). **Om de står som 🔵: det är EFTER-mätning #4–#7 på en gång, alla fyra prediktioner 🟠→🔵 träffade** — och rhinophyma är då det rena FÖRE→EFTER-testet av de-AI→AI STYLE (FÖRE 70), pigmentflackar mot AI STYLE-FÖRE 55. **Beställning: scrolla ner i AICOPY-vyn och skicka SLIGHT-raderna.**
