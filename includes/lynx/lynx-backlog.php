...
- [ ] **[lågt — RENDERAS ALDRIG, verifierat live 10 juli] "Från 799 kr" i hero-modellens `price:`-fält på FYRA sidor: akne- + rosacea-undersidorna (`hudbehandlingar/ansiktsbehandling/`) + `porrengoring.php` + `djuprengoring.php` (ägarbesked: "kika på sen")** — fältet echoas inte av mallen (0 träffar på 799 på alla fyra live-sidorna; kunder ser bara procedures-korten) ⇒ död modelldata, trolig kampanj-kvarleva — **förslag:** städa bort/rätta värdet vid nästa pass på sidorna; ofarligt tills dess. **Separat ägar-verifiering öppnad 10 juli:** stämmer PAKETpriserna på korten som FAKTISKT visas — porrengöring/djuprengöring 3995 (3 st)/4995 (5 st) och akne/rosacea 3495/4995 — mot bokningssystemet? Ägarens misstanke: 5-packet "kan vara när det kostade 1000 kr mindre"; styckpriserna 1595 är bekräftade rätt.
