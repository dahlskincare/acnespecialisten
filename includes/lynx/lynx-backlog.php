...
**Löpande / avslut**
- [ ] **Efter nästa main-push: verifiera gravstenarna på live** — `includes/lynx-copy-playbook.php` ska svara 0 bytes (de två .md-sökvägarna skapas då som tomma filer — väntat). Bakgrund (logg #70): deployen (zip + unzip -o) raderar aldrig serverfiler — utgångna/omdöpta sökvägar ligger kvar i sista deployade version och måste skrivas ÖVER, inte tas bort ur repot. **Gravstenarna finns förtecknade i filkartan i `lynx-START` (5 filer — radera ej); rutinen för framtida namnbyten/raderingar (inkl. staging-verifiering direkt) är ratificerad i §0.1 VID SLUT.** Staging verifierad 5/5 = 0 bytes 10 juli.
