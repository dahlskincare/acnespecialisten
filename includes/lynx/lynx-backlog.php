...
- [låg] Mellanslag före punkt live på `rhinophyma-rosacea.php` — blocket "…våra resultat i form av rosacea bilder på näsan **.**" (syns i EFTER-facitet 8 juli) — en teckenfix i brödtexten; typo-fixar flyttar inte betyg (belagt 2 sidor), så den kan vänta på nästa gång sidan öppnas.

*(Det senaste fyndet före detta stängdes 8 juli: §13.O:s styckeräkning — svaret var fem, båda räknarna undersköt, ingen substans förlorad. Logg #39.)*
