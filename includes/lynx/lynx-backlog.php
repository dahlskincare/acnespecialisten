...
- [ ] **Milier-/CryoPen-priser — NÄSTAN STÄNGD 10 juli (ägar-verifiering mot bokningssystemet):** ✅ milier bekräftade ("milier stämmer": enstaka 495 kr + 1595/3995/4995) · ✅ CryoPen från-pris 1995 kr bekräftat → FAQ-svaret på `hudforandringar` rättat (två 1595→1995, logg #64). **Kvar EN siffra: CryoPen-återbesöket "295 kr per åldersvårta"** (samma FAQ-mening) — obekräftat sedan 2 juli; be ägaren läsa av det ur bokningssystemet vid tillfälle.
