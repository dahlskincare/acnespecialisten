...
*(Senast stängda fynd 10 juli: §9.2-restfynden från sweepen — ≈24 `$specialist_url_title`-varianter + Verktyg-bildtitlarna — SVEPTA på ägarval samma dag, commit 7ca56e95, logg #47. Dessförinnan: mellanslaget-före-punkt på rhinophyma — fanns INTE i källan eller live (`näsan</a>.` curl-verifierad mot produktion); LYNX textextraktion infogar mellanslag när inline-länken strippas. Not i `lynx-examples`, logg #45. Dessförinnan 8 juli: §13.O:s styckeräkning, logg #39. Samma dag stängdes bildbuggen på microneedling-kortet — rättad på ägarval, logg #45.)*
