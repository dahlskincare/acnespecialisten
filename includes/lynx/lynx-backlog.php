...
**Löpande / avslut**
- [x] ~~**Efter nästa main-push: verifiera gravstenarna på live**~~ — ✅ **VERIFIERAD 10 juli efter ägarens main-push (PR #243, logg #70 addendum):** 32/32 historiska lynx-sökvägar på live svarar tomt (200/0 bytes) eller 404, 0 avvikelser; stickprov 4 innehållssidor HTTP 200 + 0 PHP-fel; mergen rörde enbart lynx-filer + gravstenar. Mappkoll båda domänerna: `/includes/` + `/includes/lynx/` → 404, ingen fillistning. **Gravstenarna står kvar i repot (filkartan i `lynx-START` — radera ej); rutinen för framtida namnbyten/raderingar är ratificerad i §0.1 VID SLUT.**
