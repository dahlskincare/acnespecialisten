...
> - **🔧 PÅGÅENDE: fil-optimeringspasset §9.0** (`lynx-backlog`) — **steg 1–8 klara.** Mål-arkitekturen ratificerad 8 juli; lagen **"ett fakta = en cell, celler pekar — återger aldrig"** gäller alla filer. **Kvar: steg 9 (examples-splitten) + steg 10 (permanentning).**
