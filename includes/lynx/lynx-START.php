...
> - **Live på main:** 8 sidor (PR #236). **På staging, väntar main-push:** mogen-hy, oonskat-har, microdermabrasion, **bristningar, solskadad-hy, rhinophyma-rosacea, pigmentflackar** (alla Fas 3 + §7.4b/workflow-verifierade) + språkfel-svep, milier-pris, Google Meet, d3ce9162. **✅ FÖRE-SEMESTER-KONTROLL 6 jul (logg #12): alla 20 ändrade sidor renderar grönt (0 PHP-fel) + §6-fraser/§3-copy-paste verifierade.**
