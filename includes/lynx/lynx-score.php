...
- **A. Overall = medel(CQ-badge, EEAT-badge) — nu 9/9, flera EXAKT:** powerlite medel(88,88)=88 ✓ · rejuve medel(87,85)=86 ✓ · splendor medel(75,85)=80≈79 · hudflikar medel(93,60)=76,5≈78 · pormaskar medel(89,60)=74,5≈76 · rhino 72,5≈74 · ytliga 73≈74 · ipl 60 · micro 60. **Formeln är BERGSÄKER nu.**
- **B. 🔴 EEAT-badge = 60 på NÄSTAN ALLA sidor; bara /varumarken/-sidor når 85–88 (KORRIGERAD — INTE "hälsosidor"):** fler datapunkter (13:38–13:40) visar att EEAT 60 gäller ÄVEN /kontakt.php, /hudproblem/, hydrafacial, portomning — alltså inte YMYL-specifikt. **Mönstret: EEAT-badge = exakt 60 på i stort sett allt UTOM de tre varumärkes-/produktsidorna** (powerlite 88, rejuve 85, splendor 85), trots att EEAT-subsen är ~85 överallt. **Två möjliga förklaringar (VET EJ vilken — se ägar-svar 6 jul):** (a) EEAT-badge genuint kapad till 60 för icke-produktsidor (LYNX ger ej en generisk sida hög auktoritet; produktsidor med teknisk spec/tillverkarsignal slipper); (b) **"60" är ett DEFAULT-/ännu-ej-uppdaterat badgevärde** (steg-vis uppdatering, ägarprincip) — badgen har inte fått sin färska beräkning medan subsen har; varumärkessidorna råkar ha hunnit uppdateras. **Samma osäkerhet gäller CQ-badge = 60** på ipl/micro/portomning/kontakt/hudproblem (subs 88–90) — kapad ELLER default-ej-uppdaterad. **GAMLA analyser stödjer (b):** om-oss (79d) EEAT-badge **59** ≈ subs 58,75, resultat (78d) EEAT **49** ≈ subs 48,75, hudforandringar **49** ≈ subs 49 — där FÖLJER EEAT-badge subsen (ingen 60-klamp) → 60-värdet är ett FÄRSK-analys-fenomen, inte permanent. **Operativ följd oavsett a/b: rör inte copy för att jaga EEAT/CQ-badge — antingen låst, eller rör sig av sig själv när LYNX uppdaterar (vänta på observerad delta, §11.1).**
