    ...
    <div class="is-hidden-touch is-hidden-desktop-only" id="footer-large">
        <div class="container">
            <div class="columns is-3 is-variable">
                <div class="column">
                    <a href="https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Skin_Consultation&Consultationwhat=EMPTY&ConsultationPlace=consultation_Clinic" title="Boka konsultation på kliniken" target="_blank" class="footer-large-banner">
                        <div class="columns">
                            <div class="column">
                ...
                <div class="column">
                    <!-- TODO: zoom link -->
                    <a href="https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Skin_Consultation&Consultationwhat=EMPTY&ConsultationPlace=consultation_online" title="Boka konsultation online" target="_blank" class="footer-large-banner">
                        <div class="columns">
                            <div class="column">
