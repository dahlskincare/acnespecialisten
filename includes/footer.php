    ...
    <div class="is-hidden-widescreen" id="footer-small">
        ...
        <div class="container">
            <div id="footer-brands">
                ...
                <a href="https://www.bokadirekt.se/sok?q=sveriges+skonhetscenter+acnespecialisten" target="_blank">
            ...
            <div id="footer-salon-cards">
                <div class="salon-card">
                    ...
                    <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-ostermalm-135539" target="_blank" class="button grey expand l10n" title="Book a visit">Boka ett besök</a>
                </div>
                <div class="salon-card">
                    <div class="flex-row">
                    ...
                    <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-sodermalm-135540" target="_blank" class="button grey expand l10n" title="Book a visit">Boka ett besök</a>
                </div>
                <div class="salon-card">
                    <div class="flex-row">
                    ...
                    <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-sundbyberg-135394" target="_blank" class="button grey expand l10n" title="Book a visit">Boka ett besök</a>
                </div>
            </div>
            <div id="footer-links">
                    ...
                    <div class="salon-card">
                        <div class="flex-row">
                            ...
                            <div>
                                <h2>Östermalm</h2>
                                <p class="p200">Strandvägen 7, 114 56 Stockholm</p>
                                <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-ostermalm-135539" target="_blank" class="button b200 compact text l10n" title="Boka tid">Boka tid</a>
                            </div>
                        </div>
                    </div>
                    <div class="salon-card">
                        <div class="flex-row">
                            ...
                            <div>
                                <h2>Södermalm</h2>
                                <p class="p200">Hornsgatan 47, 118 49 Stockholm</p>
                                <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-sodermalm-135540" target="_blank" class="button b200 compact text l10n" title="Boka tid">Boka tid</a>
                            </div>
                        </div>
                    </div>
                    <div class="salon-card">
                        <div class="flex-row">
                            ...
                            <div>
                                <h2>Sundbyberg</h2>
                                <p class="p200">Sturegatan 32, 172 31 Sundbyberg</p>
                                <a href="https://www.bokadirekt.se/places/sveriges-skonhetscenter-acnespecialisten-sundbyberg-135394" target="_blank" class="button b200 compact text l10n" title="Boka tid">Boka tid</a>
                            </div>
                        </div>
