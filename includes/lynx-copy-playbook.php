...
3. **≥3 meningar — öppningen sätter tyngdpunkten:**
   ...
   - importans/hedge/scensättning/**meta-scaffolding** ("det är viktigt att", "en rad olika faktorer", "Att navigera i…", "förstår vi vikten av", **"Här förklarar vi…"/"På denna sida går vi igenom…"**) → **SIGNIFICANT.** **MEN:** konkreta instruktioner (eftervård "håll rent, avstå smink första dygnet") stannar **SLIGHT** trots ett milt inbäddat "det är viktigt att" — importans-regeln gäller öppningen/genomgående hedge, inte en mild filler i ett annars konkret block (dermapen eftervård-p1).
