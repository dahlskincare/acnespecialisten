...
3. **≥3 meningar — öppningen sätter tyngdpunkten:**
   ...
   - importans/hedge/scensättning/**meta-scaffolding** ("det är viktigt att", "en rad olika faktorer", "Att navigera i…", "förstår vi vikten av", **"Här förklarar vi…"/"På denna sida går vi igenom…"**) → **SIGNIFICANT.** **MEN — gradient (2 jul, SKÄRPT efter blindtest 4):** räkna fyllnad vs konkretion **över HELA blocket**, inte frasen i sig. EN mild fras + konkretion direkt (mening 1–2) + REN avslutning → **SLIGHT** (acne-rygg ×2, dermapen eftervård-p1); fras + konkretion men även lätt svans → **MODERATE** (microneedling-prep, portomning-lermask); **→ SIGNIFICANT trots konkret mitt vid: staplade fraser i öppningen (2–3: "avgörande… bästa… effektiv"), fluff i BÅDA ändar (skal-öppning + importans-svans), lång + boilerplate-svans, eller hedge-stapel + AI-vokab ("spelar en viktig roll")** (ipl-eftervård, acne-demografi, ipl-rosacea Inför-p2, sebo-orsaken — blindtest 4:s fyra nya missar). **Demografisk skal-öppning räddas ALDRIG av gradienten** (hård 🔴-markör).
