...
LYNX ger både **sidnivå-AI COPY** (Pages-listan) och **per-block-facit** (AI Copy-vyn). **Gällande modell (2 jul em): sidnivå ≈ VIKTAT MEDEL av alla betygsatta block** (🟢=0, 🔵=1, 🟠=2, 🔴=3; standardavrundning där exakt ,5 rundar uppåt/mot värre — 2,09 rundar alltså NED till 🟠, inte upp). **Medel: 11/11 träffar** på sidor med kända block-counts (micro 1,44→🔵 · porto 1,00→🔵 · acne-rygg 1,38→🔵 · sebo 1,25→🔵 · mogen-hy 1,57→🟠 · microdermabrasion 1,82→🟠 · bristningar 1,92→🟠 · rhinophyma 2,06→🟠 · solskadad-hy 2,09→🟠 · pigmentflackar 2,06→🟠 · oonskat-har 1,77→🟠). **Median (historik, ersatt): 14/17** — missar mogen-hy (median 🔵, sida 🟠), solskadad-hy (median 🔴, sida 🟠) och rhinophyma (gränsfall→🔴, sida 🟠). De 6 äldre valideringssidorna (acne.php, acnebehandling, om-oss, ipl, behandla-pigment, hudforandringar) träffades av median och är ej medel-omräknade än (§9-TODO — kräver full block-count ur äldre facit). Full härledning i `lynx-examples.php` (§1.4-konsolideringen). **Starkaste modellen vi har.**
