...
## Snapshot 2026-07-02 EM (13:41–13:49) — 4 MODERATE-facit + HELSAJTS-inventering (21 dumpar totalt)
...
- *Flaggade (4 SIG + 10 MOD):* acne-ansikte✅ · behandla-pigmentflackar✅ · hudproblem/hudforandringar/✅ · ytliga-blodkarl✅ | hudbehandlingar/ipl/✅ · om-oss✅ · ipl-rosacea✅ | hudproblem/bristningar/ (facit✅) · hudproblem/oonskat-har/ (facit saknas) · microdermabrasion (facit✅) · mogen-hy (facit✅) · pigmentflackar (facit saknas) · rhinophyma-rosacea (facit✅) · solskadad-hy (facit✅)
...
1. `/` (homepage) — syntes INTE i dumparna trots att den fanns i 30 jun-datan (KW296, AIQ POOR). Troligen sorterings-/dump-lucka — **verifiera var den ligger i vyn.**
2. `/varumarken/hifu/` — NYLIGEN tillagd sida (commit d3257a9a) → LYNX har inte indexerat än. Bevaka att den dyker upp.
3. `/avbokningspolicy.php` — fanns "blank" i 30 jun-datan; syntes inte i det alfabetiska spannet (blank badge sorterar troligen under gränsen).
4. `/karriar.php` — samma som ovan.
5. `/hudbehandlingar/ansiktsbehandling/rosacea/` — ⚠️ osäker: bara 2 av repots 3 ansiktsbehandling-undersidor syntes i dumpen (akne + hudterapeutens-val).
...
2. `/behandlingar.php` (SLIGHT, AIQ POOR, VAL ~41) — ⚠️ OSÄKER läsning (rad 15, dump 1); ingen sådan fil i repot. Kan vara felläst homepage-rad ("/" har AIQ POOR). **Be ägaren kolla vad rad 15 i AICOPY-vyn faktiskt är.**
