<div id="mobile-nav-overlay" onclick="HeaderTouch.toggleMenu()">
    <nav onclick="event.stopImmediatePropagation()">
        ...
        <div id="mobile-login-link">
            ...
            <a href="https://dahlskincare.com/profile/start" target="_blank" class="button outline b200 expand l10n" title="Login">Login</a>
        </div>
    </nav>
</div>
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        <div id="desktop-login-box">
                            ...
                            <a href="https://dahlskincare.com/profile/start" target="_blank" class="button outline expand l10n" title="Login">Login</a>
                        </div>
