...
<head>
    ...
    <meta name="keywords" content="finnar av choklad, får man finnar av choklad, finnar på huvudet, dålig hy i ansiktet vuxen, finnar på magen, hur blir man av med finnar" class="l10n">
