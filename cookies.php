            ...
            <div class="container">
                  <div id="content">
                        ...
                        <section id="content">
                              ...
                              <p class="mt-l">
                                    Personal data that we process with your consent as a legal basis will be
                                    deleted if you withdraw your consent. Note, however, that this does not affect our right to
                                    process your data before any revocation.
                              </p>
                              <h3 class="mt-xl3">7. Your rights</h3>
                              <ol>
                                    <li>If you believe that we have processed your personal data incorrectly, you have the right to submit a complaint to the Swedish Data Protection Authority (IMY). You can read more about this at Imy.se.</li>
