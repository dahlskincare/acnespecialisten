<div class="result-customer-card-widget">
    <div class="customer-card-photos">
        <picture>
            ...
            <img src="<?php echo $result_customer->slider_image_before_large ?>" alt="Before" title="Before" width="178" height="238" />
        </picture>
        <picture>
            ...
            <img src="<?php echo $result_customer->slider_image_after_large ?>" alt="After" title="After" width="178" height="238" />
        </picture>
    </div>
    <div class="customer-card-content">
        ...
        <div class="treatment-details">
            ...
            <a href="/resultat/details-<?php echo $result_customer->id ?>" class="button expand outline l10n" title="View journey details">View journey details</a>
        </div>
