...
$path_segments = array(
    ...
    new PathSegment('Ärr från finnar', '/resultat-finnar-arr.php'),
);
    ...
    <main>
        ...
        <div class="container">
            ...
            <section id="cta-banner" class="large-margin">
                ...
                <div>
                    <a href="https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_Acne_Scars" class="button white expand l10n" title="Boka en gratis hudkonsultation">Boka en gratis hudkonsultation</a>
                </div>
            </section>
