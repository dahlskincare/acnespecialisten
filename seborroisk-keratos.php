...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Brand_Consultation&Consultationwhat=Brand_CryoPen', 'Boka gratis Konsultation för Seborroisk Keratos'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=cryopen&skipable_problem=Problem_seborroisk_keratos', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Brand_Consultation&Consultationwhat=Brand_CryoPen', 'Boka gratis Konsultation för Seborroisk Keratos'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=cryopen&skipable_problem=Problem_seborroisk_keratos', 'Boka denna behandling'),
      ],
...
$treatment_steps = array(
      ...
      new TreatmentStep(
            ...
            url: 'https://www.acnespecialisten.se/book?flow=cryopen&skipable_problem=Problem_seborroisk_keratos',
