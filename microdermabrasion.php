...
$description_text = '<p class="p200">MicroDermabrasion är en hudslipning som föryngrar huden genom att kickstarta dess egen förnyelse. Vi slipar varsamt bort det yttersta lagret av döda hudceller, vilket stimulerar huden att påbörja sin naturliga läkningsprocess. De gamla cellerna ger plats åt nya och fräscha, och huden blir starkare och friskare, med jämnare hudton och mer lyster.</p>';
...
$top_articles = array(
    'process' => new Article(
        ...
        content: '<p class="p200">Behandlingen börjar med en grundlig rengöring. Vi avlägsnar smuts, olja och orenheter, så att huden är ren och förberedd inför själva microdermabrasionen, en mekanisk exfoliering.</p>
        ...
        <p class="p200 mt-m">Efter exfolieringen applicerar vi serum som ytterligare förbättrar hudens hälsa. De väljs efter din hudtyp och dina behov, med ingredienser som hyaluronsyra, antioxidanter och vitaminer. Till sist lägger vi på en lugnande mask och en återfuktande kräm, som hjälper huden att återhämta sig och skyddar den mot yttre påverkan.</p>',
    ),
);
    ...
    new Service(
        ...
        procedures: array(
            new Procedure(
                ...
                price: '2595 kr',
                savings: null,
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_6_Procedure_1'
            ),
            new Procedure(
                label: '3 behandlingar',
                price: '6995 kr',
                savings: 'Spara 790 kr',
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_6_Procedure_3'
            ),
            new Procedure(
                label: '5 behandlingar',
                price: '9995 kr',
                savings: 'Spara 2980 kr',
                booking_url: 'https://boka.acnespecialisten.se?flow=dermabrasion&method=Method_MicroDermabrasion&type=Microdermabrasion_1xArea&procedures=PriceClass_6_Procedure_5'
            )
        )
    ),
);
...
$bottom_articles = array(
    'preparing' => new Article(
        ...
        image_alt: 'Förberedelse inför Microdermabrasion-ansiktsbehandling',
        image_title: 'Förberedelse inför Microdermabrasion-ansiktsbehandling',
        content: '<p class="p200">Inför din Microdermabrasion-behandling hos AcneSpecialisten erbjuder vi en kostnadsfri konsultation. Där tittar vi på din hudtyp, går igenom eventuella bekymmer och vad du kan förvänta dig av behandlingen, och du hinner ställa alla frågor du har. Efter konsultationen vet du precis vad som väntar och hur du förbereder din hud på bästa sätt.</p>',
    ),
    'aftercare' => new Article(
        ...
        content: '<p class="p200">De första dagarna efter din Microdermabrasion-behandling behöver huden extra omsorg. Skydda den från solen och använd ett solskydd med hög SPF, så förebygger du skador från UV-strålarna. Hur väl du följer eftervården påverkar också hur bra slutresultatet blir.</p>
        <p class="p200 mt-m">Har du frågor om din eftervård är du alltid välkommen att kontakta oss på AcneSpecialisten.</p>',
    ),
);
...
$faq_categories = array(
    '' => array(
        new Question(
            ...
            text: 'Ja, microdermabrasion är bra mot ärr och särskilt effektiv mot acneärr. Denna behandling hjälper till att minska synligheten av ärr genom att slipa bort det yttersta hudlagret, vilket främjar hudens naturliga läkningsprocess och cellförnyelse. Det kan leda till en jämnare hudton och förbättrad hudtextur.'
        ),
        new Question(
            title: 'Hur snabbt ser man resultat efter Microdermabrasion?',
            text: 'De flesta kunder märker en omedelbar förbättring i hudens lyster och känsla direkt efter en Microdermabrasion-behandling. För långsiktiga och mer markanta förbättringar rekommenderar vi regelbundna behandlingar, som förbättrar hudens utseende och kvalitet steg för steg.'
        ),
        new Question(
        ...
        new Question(
            ...
            text: 'Absolut. Microdermabrasion är effektiv för att behandla en rad hudproblem som fina linjer, lättare pigmentförändringar och torrhet. Den kan anpassas efter dina specifika hudbehov och problemområden.'
        ),
        new Question(
            title: 'Vad är de huvudsakliga fördelarna med Microdermabrasion jämfört med andra hudvårdsbehandlingar?',
            text: 'En av de största fördelarna med Microdermabrasion är dess förmåga att effektivt exfoliera och förnya huden utan att vara aggressiv. Detta gör behandlingen särskilt lämplig för känsliga hudtyper och dem som söker en mild men effektiv hudförbättring. Dessutom ger Microdermabrasion snabba resultat med minimal återhämtningstid jämfört med vissa mer invasiva behandlingsalternativ.'
        ),
    )
);
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i MicroDermabrasion',
        image_title: 'Cazzandra L - Expert på MicroDermabrasion'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom MicroDermabrasion',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på MicroDermabrasion'
    ),
    new Specialist(
        name: 'Vilma Libom',
