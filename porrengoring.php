...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i porrengöring',
        image_title: 'Cazzandra L - Expert på porrengöring'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom porrengöring',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på porrengöring'
    ),
    new Specialist(
        name: 'Vilma Libom',
