...
$seo_title = 'Läs mer om komedoner | AcneSpecialisten';
...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_Comedones', 'Boka gratis Konsultation för Komedoner'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=problem&problem=Problem_Comedones', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation&Consultationwhat=Problem_Comedones', 'Boka gratis Konsultation för Komedoner'),
            new Link('Boka behandling', 'https://www.acnespecialisten.se/book?flow=problem&problem=Problem_Comedones', 'Boka denna behandling'),
      ],
...
$description_text = '<p class="p200">Komedoner uppstår när porer täpps till av talg och döda hudceller. De syns som svarta eller vita prickar på huden, ofta i områden som ansiktet, näsan och pannan.</p>
...
<head>
      ...
      <link rel="canonical" href="https://www.acnespecialisten.se/komedoner.php" />
