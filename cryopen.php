...
$types = array(
    ...
    new Service(
        ...
        booking_url: 'https://acnespecialisten.se/book?flow=cryopen&skipable_problem=Problem_age_spots',
        booking_url_label: 'Boka behandling',
        ...
        <div class="container">
            <div id="content">
                ...
                <section id="specialists" class="large-margin">
                    ...
                    <a class="mt-xl button b200 outline expand auto-width l10n" href="/hudterapeuter" title="Se alla hudterapeuter"><?php echo $specialists_view_more ?></a>
                </section>
            </div>
            <section id="brands">
                <div class="flex-row align-end justify-space-between">
