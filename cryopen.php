...
$description_text = '<p class="p200">CryoPen är ett verktyg som på under 20 sekunder effektivt fryser bort godartade hudförändringar. “Kryo” i kryobehandling betyder frysning, och denna populära metod används världen över. Behandlingen ger snabba resultat, är skonsam mot huden och är idealisk för olika typer av hudförändringar för dig som vill <a class="b200 underline color-deep-sea-400" href="/fodelsemarken.php" title="Mer information om att ta bort födelsemärken">ta bort födelsemärken</a>, leverfläckar, hudflikar, ansiktsvårtor och andra utåtstående märken och skönhetsfläckar.</p>
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i CryoPen-behandlingar',
        image_title: 'Cazzandra L - Expert på CryoPen-behandlingar'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom CryoPen-behandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på CryoPen'
    ),
    new Specialist(
        name: 'Vilma Libom',
