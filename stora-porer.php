...
$articles = array(
      ...
      new Article(
            ...
            <p class="p200 mt-m">Att välja AcneSpecialisten innebär att du får tillgång till den mest avancerade och effektiva behandlingen för dina stora porer. Vårt engagemang, kunskap och erfarenhet gör oss till ditt bästa val när det kommer till behandling av stora porer.</p>',
      ),
