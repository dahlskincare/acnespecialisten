...
$services = array(
    ...
    new Service(
        ...
        price: 'Från 1595 kr',
        icons: array(),
        content: '<p class="p200">Kemisk peeling är en effektiva acne behandling. Vi använder en speciell syra som appliceras på huden för att avlägsna det översta hudlagret. Detta ger plats åt ny, frisk hud att växa fram, vilket bidrar till att akne och att förbättra hudens textur och utseende.</p>',
