...
$top_articles = array(
    'process' => new Article(
        ...
        content: '<p class="p200">Portömning är en noggrann ansiktsbehandling med målet att djuprengöra porerna och avlägsna orenheter för att <a class="b200 underline color-deep-sea-400" href="/pormaskar.php" title="Mer information om pormaskar">få bort pormaskar</a>, finnar och akne, vilket bidrar till att minimera porernas storlek. Behandlingen påbörjas med att huden varsamt rengörs för att tvätta bort yttre orenheter såsom talg och smuts, följt av en peelingtvätt som exfolierar och tar bort döda hudceller.</p>
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i portömning',
        image_title: 'Cazzandra L - Expert på portömning'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom portömning',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på portömning'
    ),
    new Specialist(
        name: 'Vilma Libom',
