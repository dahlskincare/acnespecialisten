...
$trivias = array(
      ...
      new ProblemTrivia(
            prefix: 'Var',
            title: 'får man torr och känslig hy?',
            content: '<p class="p200">Medan torr och känslig hy kan drabba hela kroppen, finns det vissa områden som är extra utsatta. Ansiktet är ofta det mest drabbade området, och det är också här som symptomen vanligtvis är mest synliga. Specifika delar av ansiktet som ögonområdet och runt munnen har särskilt tunn hud och är mer känsliga för torrhet och irritation. Händerna är också ett kritiskt område och är extra utsatta på grund av den ständiga exponeringen för vatten, tvål och desinfektionsmedel.</p>',
