...
$green_banner_content = new GreenBannerContent(
      ...
      links_touch: [
            new Link('Boka konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_DrySensitiveSkin', 'Boka gratis konsultation'),
            new Link('Boka behandling', 'https://boka.acnespecialisten.se?flow=facialClassic', 'Boka denna behandling'),
      ],
      links_desktop: [
            new Link('Boka gratis konsultation', 'https://boka.acnespecialisten.se?flow=consultation&ConsultationType=Consultation_Problem&Consultationwhat=Consultation_Problem_DrySensitiveSkin', 'Boka gratis konsultation'),
            new Link('Boka behandling', 'https://boka.acnespecialisten.se?flow=facialClassic', 'Boka denna behandling'),
      ],
...
$trivias = array(
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">För att motverka de åldrande effekterna av torr hud är det viktigt att fokusera på återfuktning och näring. Detta kan inkludera användning av återfuktande behandlingar och hudvårdsprodukter, dricka tillräckligt med vatten, och skydda huden från solen med hjälp av solskydd. Genom att bibehålla hudens fuktighetsnivåer och skydda den mot yttre påfrestningar kan man hjälpa till att sakta ner åldrandeprocessen.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
...
$specialists = array(
      ...
      new Specialist(
            ...
            image_alt: 'Julia Eklund, hudterapeut med kunskap inom hantering av torr och känslig hy',
            image_title: 'Julia Eklund - Hudterapeut specialiserad på torr och känslig hy'
      ),
      new Specialist(
            name: 'Vilma Libom',
