...
$trivias = array(
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Torr hy tenderar att åldras snabbare än oljig eller normal hud på grund av flera faktorer. När huden är torr saknar den fukt och olja, vilket är avgörande för att bibehålla hudens elasticitet och smidighet. Här är en närmare förklaring av processen:</p>
            <p class="p200 mt-xl">**Minskad oljeproduktion:** Torr hud producerar mindre talg, den naturliga oljan som hjälper till att behålla fukten i huden. När talgproduktionen minskar, kan huden inte behålla fukt lika effektivt, vilket leder till att den blir torr och stram.</p>
            <p class="p200 mt-xl">Försämrad fuktbarriär:** Hudens yttre lager, kallat stratum corneum, fungerar som en barriär som skyddar kroppen mot yttre påverkan och hjälper till att behålla fukt. Torr hud har ofta en skadad eller försämrad barriär, vilket gör den mer sårbar för miljöskador som solstrålning och föroreningar. Detta kan accelerera hudens åldrandeprocess.</p>
            <p class="p200 mt-xl">Ökad tendens till fina linjer och rynkor:** När huden är torr och uttorkad, blir fina linjer och rynkor mer framträdande. Fuktighet är avgörande för att ge huden dess fylliga, elastiska utseende. Utan tillräcklig fuktighet kan huden inte "plumpas upp" från insidan, vilket gör att tecken på åldrande blir mer synliga.</p>
            <p class="p200 mt-xl">Känslighet för irritation:** Torr hud är mer benägen att bli irriterad, vilket kan leda till inflammation. Kronisk inflammation kan bryta ner kollagen och elastin i huden, vilket är proteiner som är viktiga för hudens struktur och elasticitet. När dessa proteiner bryts ner, förlorar huden sin fasthet och rynkor bildas lättare.</p>
            <p class="p200 mt-xl">Långsam cellomsättning:** Torr hud kan också ha en långsammare cellomsättning eller cellförnyelse. Detta innebär att gamla, döda hudceller stannar kvar på hudytan längre, vilket kan ge huden ett tråkigt, åldrat utseende.</p>
            <p class="p200 mt-xl">För att motverka de åldrande effekterna av torr hud är det viktigt att fokusera på återfuktning och näring. Detta kan inkludera användning av återfuktande krämer och serum, dricka tillräckligt med vatten, och skydda huden från solen med hjälp av solskydd. Genom att bibehålla hudens fuktighetsnivåer och skydda den mot yttre påfrestningar kan man hjälpa till att sakta ner åldrandeprocessen.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
