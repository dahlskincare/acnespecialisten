...
$trivias = array(
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Att hantera torr och känslig hud i ansiktet kräver en skonsam men effektiv hudvårdsrutin. Det börjar med milda rengöringsprodukter som inte strippar huden på dess naturliga oljor, följt av återfuktande produkter som är fria från irriterande ämnen. Produkter med hyaluronsyra, ceramider och glycerin kan hjälpa till att låsa in fukt och stärka hudens barriär. För de extra känsliga områdena, som ögonområdet, kan det vara värt att investera i specialformulerade krämer som är utformade för att minimera irritation och återfukta djupt.</p>
            <p class="p200 mt-xl">Att vara uppmärksam på hur olika områden i ansiktet reagerar på produkter och miljöförändringar är nyckeln till att upprätthålla en hälsosam, återfuktad och lugn hud.</p>',
