...
$seo_image = 'bilder/varumarken/424x456/dermapen.webp';
...
$top_articles = array(
    'preparing' => new Article(
        ...
        content: '<p class="p200">Att förbereda sig för en Dermapen behandling innebär att först genomgå en detaljerad konsultation med en av våra hudterapeuter. Vi erbjuder Dermapen på Östermalm, Södermalm och i Sundbyberg. Under konsultationen utförs en noggrann bedömning av din hud för att identifiera individuella behov och särskilda hudproblem. Denna initiala analys är kritisk för att utforma en personlig behandlingsplan som är perfekt anpassad för dina unika hudvårdsbehov.</p>
...
$types = array(
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=Problem_LargePores&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=Problem_Wrinkles&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=Problem_PigmentationSpots',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=Problem_StrechMarks',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=Problem_Acne',
        booking_url_label: 'Boka behandling',
...
$big_types = array(
    new Service(
        ...
        consultation_url_label: 'Boka hudkonsultation',
        consultation_url_title: 'Boka tid för hudkonsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=dermapen&skipable_problem=SKIP&area=Microneedling+PRX-T33-Boost',
        booking_url_label: 'Boka behandling',
        booking_url_title: 'Boka tid för behandling',
        icons: array(),
        procedures: array()
...
$results_images = array(
    ...
    new LabelImage(
        ...
        image_title: 'Dermapen resultat - ärr på ryggen',
        content: '',
    ),
    new LabelImage(
...
$specialists = array(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom Dermapen behandling',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på Dermapen'
    ),
    new Specialist(
        name: 'Vilma Libom',
