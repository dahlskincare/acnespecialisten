...
$faq_categories = array(
      'Generellt om mogen hy' => array(
            ...
            new Question(
                  ...
                  text: '<p class="p200">Genetik spelar en betydande roll i processen för hudens åldrande. Om dina föräldrar eller nära släktingar har en huds som åldras långsamt eller visa tecken på åldrande vid en högre ålder, kan du också ha en genetisk benägenhet att uppleva samma saker. Detta betyder dock inte att externa faktorer som solexponering och livsstilsval inte kommer att ha någon inverkan.</p>'
            ),
            new Question(
