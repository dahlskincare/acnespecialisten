...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: ' är mogen hy?',
            content: '<p class="p200">Mogen hy är hud som börjat visa ålderstecken: rynkor, fina linjer, förlust av spänst och elasticitet, torrhet, ojämn hudton, pigmentfläckar och förtjockning av huden. Med åren blir huden också tunnare och sämre på att hålla kvar fukt. Många märker dessutom att hyn rodnar lättare och läker långsammare efter skador.</p>',
            ...
            <p class="p200 mt-xl">Utöver detta påverkas huden av de naturliga sänkningarna av vissa hormoner i kroppen. Till exempel minskar både det manliga och kvinnliga könshormonerna med åldern, vilket direkt påverkar hudens förmåga att producera kollagen och bevara fukt. Denna hormonella förändring kan leda till en ökad torrhet och en minskning av hudens övergripande tjocklek och densitet. Med tiden kan huden också förlora sin förmåga att effektivt förnya sig själv. Döda hudceller samlas då på ytan, vilket ger en ojämn hudton.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            title: ' får man mogen hy?',
            content: '<p class="p200">Hudens biologiska åldrande börjar redan i 20-årsåldern. Med tiden minskar produktionen av kollagen, proteinet som bär upp hudens struktur, och huden blir då tunnare och mindre elastisk. Det är just detta som syns som rynkor och fina linjer. Samtidigt sjunker hudens naturliga talgproduktion, så huden blir torrare, och självläkningsförmågan avtar, vilket ger längre återhämtningstid efter skador.</p>',
            ...
            <p class="p200 mt-xl">Våra livsstilsval kan även influera hur vår hud åldras. Saker som otillräcklig sömn, dålig kost, stress och alkoholkonsumtion kan alla bidra till att vår hud åldras i förtid. Omvänt kan en balanserad kost rik på antioxidanter, regelbunden motion och tillräckligt med sömn hjälpa till att stödja hudens hälsa och fördröja åldrandet. Våra gener påverkar också hur och när vi börjar visa tecken på åldrande. Vissa människor kan börja märka dessa tecken tidigare än andra på grund av deras genetiska anlag. Alla faktorer går inte att kontrollera, men medvetna val och förståelse gör det lättare att ta hand om huden.</p>',
            icons: array('genetik' => 'Genetik', 'hormoner' => 'Hormoner', 'livsstil' => 'Livsstil', 'sol' => 'Sol')
      ),
      new ProblemTrivia(
            prefix: 'Vem',
            title: ' får mogen hy?',
            content: '<p class="p200">Generna styr mycket av när de första tecknen på mogen hy dyker upp. Precis som vissa familjer tidigt får gråa hår eller skallighet, kan andra ha ett genetiskt anlag för tidiga rynkor eller åldersfläckar. Yttre faktorer som sol och livsstil påverkar också hur tidigt och hur tydligt förändringarna framträder, och därför varierar det kraftigt mellan individer, trots att alla förr eller senare får mogen hy. Generna går inte att ändra, men den som känner till sina genetiska tendenser kan anpassa sin hudvård efter dem.</p>',
            ...
            <p class="p200 mt-xl">Livsstil och allmän hälsa har också en inverkan. Rökare, till exempel, kan märka tecken på mogen hy tidigare än icke-rökare på grund av de skadliga kemikalierna i cigaretter. På samma sätt kan de som utsätter sig för mycket stress eller inte följer en hälsosam diet också se tecken på åldrande tidigare. Åldrandet är i grunden en naturlig process som alla till slut upplever, även om tecknen går att fördröja. Medvetenhet och proaktiv hudvård kan bromsa och motverka ålderstecknen.</p>',
            icons: array('man-kvinna' => 'Män & Kvinnor', 'vuxna' => 'Vuxna', '65+' => 'Äldre')
      ),
      new ProblemTrivia(
            prefix: 'Var',
            title: ' får man mogen hy?',
            content: '<p class="p200">Ansiktet är området där mogen hy syns tydligast, eftersom det är exponerat för sol och väder året om. Här uppstår fina linjer, rynkor, pigmentförändringar och förlorad elasticitet, särskilt runt ögonen, munnen och på pannan. Även halsen och dekolletaget är utsatta. Huden där är tunnare än på resten av kroppen och därför extra känslig för solskador och annan yttre påverkan, så åldersfläckar, linjer och förlorad fasthet är vanliga även här.</p>',
            ...
            <p class="p200 mt-xl">Ålderstecken kan också påverka huden över hela kroppen, inte bara på ytan. Åldrandet påverkar hudens djupare lager, vilket minskar produktionen av kollagen och elastin, två proteiner som är avgörande för hudens struktur och elasticitet. Tecknen är naturliga och en del av åldringsprocessen, men de går att fördröja och dämpa med solskydd, rätt hudvård och behandlingar. Oavsett var på kroppen tecknen på mogen hy uppträder finns det behandlingar som hjälper dig att känna dig mer bekväm och självsäker i din hud.</p>',
...
$treatment_steps = array(
      new TreatmentStep(
            title: 'Identifiera',
            content: 'Hos oss får du en personlig hudterapeut som hjälper dig att identifiera tecknen på mogen hy och skapar en skräddarsydd behandlingsplan.',
...
$articles = array(
      new Article(
            ...
            content: '<p class="p200">Fina linjer, rynkor och förlorad elasticitet är en naturlig del av åldrandet, men för vissa kan de påverka självkänslan och orsaka obehag. Det är dags att söka professionell hjälp när ålderstecknen börjat påverka hur du mår, när du provat produkter och behandlingar på egen hand utan att se resultat, eller helt enkelt när du vill förbättra hudens utseende. Någon "minsta gräns" för när det är lämpligt att söka professionell hudvård finns inte, och det är heller aldrig för sent.</p>
            <p class="p200 mt-m">Hos en hudspecialist får du en personlig konsultation där hudterapeuten analyserar din hudtyp, går igenom vad som ligger bakom just dina hudförändringar och rekommenderar rätt behandling, allt från djuprengöring och återfuktning till laser och hudföryngring. Utifrån analysen får du en behandlingsplan anpassad efter din hud.</p>',
      ),
      ...
      new Article(
            ...
            <p class="p200 mt-m">Att välja AcneSpecialisten betyder inte bara tillgång till den mest avancerade behandlingen för din hud. Vi är dedikerade till att du ska uppnå dina hudvårdsmål. Vår djupa kunskap, engagemang och långvariga erfarenhet gör oss till ditt främsta val för att ta hand om din mogna hy.</p>',
      ),
...
$faq_categories = array(
      'Generellt om mogen hy' => array(
            new Question(
                  ...
                  text: '<p class="p200">Mogen hy hänvisar till hud som börjar visa tecken på åldrande. Tecknen inkluderar rynkor, fina linjer, förlust av elasticitet, förtunning av huden, ojämn hudton, pigmentförändringar och minskad fuktighet. Medan åldrande är en naturlig process, kan yttre faktorer som solexponering, kost och livsstilsval också påverka hudens åldrande.</p>'
            ),
            new Question(
...
$specialists = array(
      new Specialist(
            ...
            image_alt: 'Cazzandra L, hudterapeut med specialisering i behandling av mogen hy',
            image_title: 'Cazzandra L - Expert på behandling av mogen hy'
      ),
      new Specialist(
