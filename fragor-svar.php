...
$faq_categories = array(
    'Bokning' => array(
        ...
        new Question('Hur når jag er utöver telefon?', '<p class="p200">Förutom att ringa oss på 08 29 61 01 kan du kontakta oss via e-post på info@acnespecialisten.se eller genom chatten som du hittar nere i högra hörnet på vår webbplats. Vi strävar efter att svara på alla förfrågningar inom en arbetsdag.</p>'),
    ),
    'Problemhy' => array(
