...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i djuprengöring',
        image_title: 'Cazzandra L - Expert på djuprengöring'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom djuprengöring',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på djuprengöring'
    ),
    new Specialist(
        name: 'Vilma Libom',
