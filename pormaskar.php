...
$seo_title = 'Pormaskar – Behandling & orsaker | AcneSpecialisten';
...
$trivias = array(
      new ProblemTrivia(
            ...
            extended_content: '<p class="p200 mt-xl">Det finns två typer av pormaskar: öppna och stängda. De öppna pormaskarna, kända som <a class="b200 underline color-deep-sea-400" href="/svarta-pormaskar.php" title="Mer information om svarta pormaskar">svarta pormaskar</a>, ser ut som små svarta prickar på huden. Denna svarta färg orsakas inte av smuts, som många tror, utan av oxidation. När talg och döda hudceller utsätts för luft, oxideras de, vilket leder till att de mörknar. De stängda pormaskarna, å andra sidan, är vita eller hudfärgade och kallas <a class="b200 underline color-deep-sea-400" href="/vita-pormaskar.php" title="Mer information om vita pormaskar">vita pormaskar</a> eller slutna komedoner. I dessa fall är hårsäckens öppning täckt av tunn hud, vilket förhindrar oxidation och behåller därför den ljusa färgen. Detta resulterar i pormaskar som inte går att klämma.</p>
...
$services = array(
      ...
      new Service(
            ...
            booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Comedones&method=Service_Facial_PoreExtraction',
      ...
      new Service(
            ...
            booking_url_label: 'Boka behandling',
            booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Comedones&method=Method_LaserProblem',
      ...
      new Service(
            ...
            booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Comedones&method=Method_ChemicalPeeling',
            booking_url_label: 'Boka behandling',
      ...
      new Service(
            ...
            booking_url_label: 'Boka behandling',
            booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Comedones&method=Method_Microneedling',
...
$specialists = array(
      ...
      new Specialist(
            ...
            image_alt: 'Julia Eklund, hudterapeut med kunskap inom pormaskhantering',
            image_title: 'Julia Eklund - Hudterapeut specialiserad på pormaskar'
      ),
      new Specialist(
            name: 'Vilma Libom',
