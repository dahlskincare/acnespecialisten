...
$trivias = array(
      new ProblemTrivia(
            prefix: 'Vad',
            title: 'är pormaskar?',
            content: '<p class="p200">Pormaskar, även kända som komedoner, är små prickar som tillhör aknefamiljen. De uppstår när öppningarna av dina hårsäckar blir tilltäppta av en blandning av talg och döda hudceller. Talg är en naturlig talg som produceras av talgkörtlarna i huden, och dess primära funktion är att hålla huden och håret mjukt och hydratiserat. Döda hudceller är normala biprodukter av hudens ständiga förnyelseprocess.</p>',
      ...
      new ProblemTrivia(
            prefix: 'Vem',
            title: 'får pormaskar?',
            content: '<p class="p200">Det är en vanlig missuppfattning att pormaskar endast drabbar tonåringar eller personer med fet hud. I verkligheten är det en hudåkomma som kan påverka personer i alla åldrar och hudtyper. Här är en djupgående titt på de olika grupperna som är mest benägna att utveckla pormaskar. För det första är ungdomar i puberteten särskilt utsatta. Hormonella förändringar under dessa formella år leder ofta till överaktiv talgproduktion, vilket i sin tur kan bidra till pormaskar. Även om det kan verka som att pormaskar försvinner med åldern, är det inte alltid fallet. Vuxna, särskilt de i åldrarna 30 till 50, kan också uppleva pormaskar, ofta som ett resultat av hormonella förändringar relaterade till menstruation, graviditet eller klimakteriet.</p>',
