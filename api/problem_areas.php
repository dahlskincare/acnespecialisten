...
$query = "SELECT id, name_$language AS name, duration_minutes, price, area_type, image_url FROM $dbname.problem_area WHERE $where ORDER BY $dbname.problem_area.rank ASC LIMIT 1000";
