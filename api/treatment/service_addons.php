...
$query = "
    SELECT id, image_url, label_$language AS label, title_$language AS title, subtitle_$language AS subtitle, description_$language AS description 
    FROM $dbname.treatment_service_addon 
    WHERE $where 
    ORDER BY $dbname.treatment_service_addon.rank 
    LIMIT 1000";
