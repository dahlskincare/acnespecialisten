...
$query = "SELECT id, image_url, duration, price, name_$language AS name, description_$language AS description FROM $dbname.treatment_service WHERE $where ORDER BY $dbname.treatment_service.rank LIMIT 1000";
