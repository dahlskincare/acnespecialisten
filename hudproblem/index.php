...
$problems['pigmentflackar'] = new Problem(
      ...
      booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_PigmentationSpots',
...
$problems['hudforandringar'] = new Problem(
      ...
      booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Moles',
...
$problems['mogen-hy'] = new Problem(
      ...
      booking_url: 'https://boka.acnespecialisten.se?flow=problem&problem=Problem_Wrinkles',
...
<body>
      ...
      <main>
            <section id="banner">
                  <?php include($_SERVER['DOCUMENT_ROOT'] . '/includes/widgets/green_header_banner/hudproblem_green_header_banner.php'); ?>
