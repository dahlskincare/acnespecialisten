...
$seo_description = 'Utforska de mest effektiva behandlingsmetoderna för hudförändringar. Få skräddarsydda råd, tips, och expertis för att behandla och minska hudförändringar.';
...
$model = new Service(
    ...
    duration: null,
    price: null,
    content: 'Här har vi samlat de mest effektiva metoderna för behandling av hudförändringar som hjälper dig att effektivt behandla dessa förändringar. Oavsett ditt specifika behov, har vi rätt lösning för dig. Är du osäker på vilken <a href="https://www.acnespecialisten.se">behandling</a> som bäst passar din hudtyp för att hantera hudförändringar? Oroa dig inte, boka en kostnadsfri konsultation hos oss på AcneSpecialisten så hjälper vi dig vidare mot en bättre hy.',
