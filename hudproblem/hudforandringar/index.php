...
$trivias = array(
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Fibrom och andra hudutväxter kan vara mjuka eller fasta och variera i färg från hudfärgad till svart. De flesta är ofarliga och kräver ingen behandling, men kan tas bort av kosmetiska skäl eller om de skaver.</p>',
            icons: array()
      ),
      new ProblemTrivia(
            prefix: 'Varför',
            title: ' får man hudförändringar?',
            content: '<p class="p200">Hudförändringar beror på flera saker, både inre och yttre. Genetik spelar ofta en stor roll. Till exempel kan födelsemärken och vissa typer av leverfläckar ärvas från föräldrar till barn. Om det finns en familjehistoria av vissa hudförändringar, är chansen större att andra familjemedlemmar också kommer att utveckla dem. Miljöfaktorer är också avgörande. Solens ultravioletta strålar är en känd orsak till många hudförändringar, inklusive leverfläckar, födelsemärken och seborroiska keratoser. Långvarig och oskyddad exponering för solen kan inte bara leda till en ökning av antalet hudförändringar, utan också förändra de som redan finns. Detta understryker vikten av att använda solskydd och att ta andra försiktighetsåtgärder när man är utomhus.</p>',
      ...
      new ProblemTrivia(
            ...
            <p class="p200 mt-xl">Hälsotillstånd och mediciner kan också påverka huden. Personer med vissa autoimmuna sjukdomar är mer benägna att utveckla specifika hudförändringar, och vissa mediciner kan ge hudförändringar som biverkning.</p>',
            icons: array('man-kvinna' => 'Män & Kvinnor', 'barn' => 'Barn', 'tonaringar' => 'Tonåringar', 'vuxna' => 'Vuxna', '65+' => 'Äldre')
      ),
      new ProblemTrivia(
            prefix: 'Var',
            title: ' får man hudförändringar?',
            content: '<p class="p200">Hudförändringar kan uppstå överallt på kroppen, men vissa områden är mer utsatta. Ansiktet och huvudet är bland de vanligaste, eftersom de ständigt möter sol, vind och föroreningar. Här kan du hitta allt från födelsemärken och åldersvårtor till seborroisk keratos. På grund av den ökade solens exponering är leverfläckar och födelsemärken också vanliga i detta område, särskilt på kinderna, näsan och pannan. Händer och armar, som också ofta är exponerade, kan visa tecken på åldrande snabbare än mer skyddade områden. Här kan man se leverfläckar, åldersvårtor eller solskadad hud. Dessutom kan hudutväxter eller hudflikar utvecklas i områden med friktion, såsom axlar eller under bysten.</p>',
            ...
            <p class="p200 mt-xl">Hudens tjocklek, mängden fettvävnad och graden av solskydd påverkar också vilken typ av hudförändring som är mest sannolik i ett visst område.</p>',
...
$treatment_steps = array(
      new TreatmentStep(
            title: 'Identifiera',
            content: 'Hos oss får du träffa en hudterapeut som undersöker dina godartade hudförändringar och skapar en individuell behandlingsplan.',
...
$type_categories = array(
      new BasedTypeCategory(
            ...
            content: '<p class="p200">Hudförändringar uppstår av flera skäl: genetik, ålder, sol, hormoner och skador. Nedan går vi igenom de vanligaste godartade typerna vi behandlar.</p>',
            types: array(
                  new BasedType(
                        title: 'Ansiktsvårta',
                        subtitle: '',
...
$articles = array(
      new Article(
            ...
            content: 'Hudförändringar är oftast ofarliga, men de kan påverka självkänslan. En synlig fläck eller utväxt i ansiktet kan kännas jobbig, och när den börjar tynga dig kan det vara läge att söka hjälp.',
            extended_content: 'Hos en hudterapeut får du en bedömning och förslag på behandling som passar dig. Känner du att hudförändringarna tär på självförtroendet är en kostnadsfri konsultation första steget. Observera att vi på AcneSpecialisten inte kan diagnostisera om dina hudförändringar är elakartade.'
      ),
      new Article(
            ...
            content: 'Hos oss får du hjälp av en hudterapeut som undersöker dina hudförändringar och anpassar behandlingen efter just dig. Vi behandlar godartade hudförändringar med laser och CryoPen, och går igenom vad som passar din hud.',
            extended_content: 'Oavsett om det gäller en enstaka fläck eller flera hudförändringar är du välkommen att höra av dig för en kostnadsfri konsultation.',
      ),
);
...
$specialists = array(
      new Specialist(
            ...
            image_alt: 'Cazzandra L, hudterapeut med specialisering i behandling av hudförändringar',
            image_title: 'Cazzandra L - Expert på behandling av hudförändringar'
      ),
      new Specialist(
