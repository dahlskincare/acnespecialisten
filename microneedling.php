    ...
    new TreatmentArea(
        ...
        items: array(
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_Face',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '30 min',
                price: '2595 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_Cheeks',
                url_label: 'Boka',
    ...
    new TreatmentArea(
        ...
        items: array(
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_Neck',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_Decolletage',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_Back',
                url_label: 'Boka',
    ...
    new TreatmentArea(
        ...
        items: array(
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=microneedling&skipable_problem=SKIP&area=Microneedling_1xArea',
                url_label: 'Boka',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i microneedling',
        image_title: 'Cazzandra L - Expert på microneedling'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom microneedling',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på microneedling'
    ),
    new Specialist(
        name: 'Vilma Libom',
