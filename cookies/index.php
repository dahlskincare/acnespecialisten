...
<body>
      ...
      <main>
            ...
            <div class="container">
                  <div class="cookies-title">Cookies & privacy policy</div>
                  <div class="cookies-subtitle">At Acnespecialisten there is an experienced and well-educated group of doctors 
                  with specialist skills and broad experience from the aesthetic and reconstructive industry.</div>
                  <div class="flex-row cookies-about-tab">
                        <a class="" href="">About cookies</a> <a class="cookies-about-tab-privacy-policy" href="">Privacy policy</a>
                  </div>
                  
                  <div class="cookies-about-cookies">About cookies</div>
                  ...
                  <h2 class="mt-xl3">Privacy Policy</h2>
