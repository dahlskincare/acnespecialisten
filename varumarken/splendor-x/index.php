...
$combos = array(
    new ServiceCombo(
        ...
        duration: '80 min',
        price: '4190 kr',
        booking_url: 'https://boka.acnespecialisten.se?flow=permanent_harborttagning_SX&area_ms=UnwantedHair_LegsFull',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i behandling med Splendor X',
        image_title: 'Cazzandra L - Expert på behandling med Splendor X'
    ),
    new Specialist(
