...
$green_banner_content = new GreenBannerContent(
      title: 'Varumärken',
      description: 'På AcneSpecialisten samarbetar vi med branschledande leverantörer för att säkerställa att vi använder de mest avancerade teknikerna inom hudvård. Denna kombination av toppmodern teknik och expertkompetens möjliggör de bästa möjliga resultaten för våra kunder. Resultat och kvalitet står i centrum för vår verksamhet, och vi kompromissar aldrig med standarden på vår utrustning.',
...
$brand_cards = array(
      ...
      new Brand(
          ...
          title: 'Skin Tech',
          subtitle: 'Effektiva kemisk peeling behandlingar',
          description: 'Skin Tech är känd för sina kemiska peelingbehandlingar, designade för att adressera en rad specifika hudvårdsbehov. Dessa behandlingar använder innovativa formuleringar som effektivt förbättrar hudens hälsa och utseende, med ett konstant fokus på resultat.',
          url: 'skin-tech.php',
