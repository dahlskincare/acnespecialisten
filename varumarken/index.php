...
$brand_cards = array(
      ...
      new Brand(
          ...
          photo_title: 'CryoPen',
          title: 'CryoPen',
          subtitle: 'Effektiv frysbehandling för hudförändringar',
      ...
      new Brand(
          ...
          title: 'Dermapen',
          subtitle: 'Microneedling som jämnar ut huden',
      ...
      new Brand(
          ...
          photo_title: 'Exceed',
          title: 'Exceed',
          subtitle: 'Microneedling behandling',
      ...
      new Brand(
          ...
          title: 'HydraFacial',
          subtitle: 'Exfolierar och förnyar huden',
      ...
      new Brand(
          ...
          photo_title: 'PRX-T33',
          title: 'PRX-T33',
          subtitle: 'Maximal effekt med minimal återhämtning',
