...
$types = array(
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_PigmentationSpots',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_StrechMarks',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_Wrinkles&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_SunDamage&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        consultation_url_label: 'Boka konsultation',
        consultation_url_title: 'Boka tid för hudkonsultation',
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_AcneScars',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_Acne',
        booking_url_label: 'Boka behandling',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_LargePores&area=EMPTY',
    ...
    new Service(
        ...
        booking_url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=Problem_Melasma&area=EMPTY',
        booking_url_label: 'Boka behandling',
    ...
    new TreatmentArea(
        ...
        items: array(
            new TreatmentAreaItem(
                ...
                duration: '40 min',
                price: '1995 kr',
                url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=SKIP&area=ChemicalPeeling_Face',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '40 min',
                price: '1995 kr',
                url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=SKIP&area=ChemicalPeeling_Neck',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '40 min',
                price: '1995 kr',
                url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=SKIP&area=ChemicalPeeling_Decolletage',
                url_label: 'Boka',
            ...
            new TreatmentAreaItem(
                ...
                duration: '40 min',
                price: '1995 kr',
                url: 'https://boka.acnespecialisten.se?flow=skintech&skipable_problem=SKIP&area=ChemicalPeeling_Back',
                url_label: 'Boka',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Skin Tech-behandlingar',
        image_title: 'Cazzandra L - Expert på Skin Tech-behandlingar'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom Skin Tech-behandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på Skin Tech'
    ),
    new Specialist(
        name: 'Vilma Libom',
