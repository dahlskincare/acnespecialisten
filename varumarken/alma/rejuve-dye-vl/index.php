...
$top_articles = array(
    'process' => new Article(
        ...
        content: '<p class="p200">När du anländer till en av våra kliniker börjar vi med att rengöra din hud grundligt för att avlägsna alla spår av smink och orenheter. Ett speciellt skydd placeras över dina ögon för att skydda dem från det intensiva ljuset under behandlingen.</p>
    ...
    new TreatmentArea(
        ...
        items: array(
            ...
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2595 kr',
                url: 'https://acnespecialisten.se/book?flow=almarejuve&skipable_problem=SKIP&area=IPL_1xArea',
                url_label: 'Boka',
