...
<head>
    ...
    <title class="l10n">Acnespecialisten | Alma - Hybrid (C02)</title>
    ...
    <link rel="stylesheet" href="varumarken/brand_treatment.css">
</head>
        ...
        <div class="container">
            <div id="floating-picture" style="background-image: url('images/problems/carousel/large/acne-scars.jpg')">
                <div id="overlay">
                    ...
                    <div>
                        <h2 class="h600 l10n">Alma - Hybrid (C02)</h2>
        ...
        <section id="header">
            <div id="green-header-small" class="is-hidden-desktop">
                <div class="container">
                    ...
                    <h1 class="mt-xs h600 l10n">Alma - Hybrid (C02)</h1>
        ...
        <div class="container">
            <div id="content">
                ...
                <section id="about" class="large-margin">
                    <h2 class="h500 l10n">What is Alma - Hybrid C02?</h2>
                ...
                <section id="problems" class="large-margin">
                    <h2 class="h500 l10n">Problems treated with Alma - Hybrid (C02)</h2>
