...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Rejuve-behandlingar',
        image_title: 'Cazzandra L - Expert på Rejuve-behandlingar'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom Rejuve-behandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på Rejuve'
    ),
    new Specialist(
        name: 'Vilma Libom',
