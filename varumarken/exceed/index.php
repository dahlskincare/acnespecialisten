...
$model = new Service(
    ...
    consultation_url: 'https://www.bokadirekt.se/boka-tjanst/sveriges-skonhetscenter-acnespecialisten-sundbyberg-135394/konsultation-exceed-3434281',
    consultation_url_label: 'Boka hudkonsultation',
    consultation_url_title: 'Boka tid för hudkonsultation',
    booking_url: 'https://boka.acnespecialisten.se?flow=exceed&area=Microneedling_1xArea',
    ...
    procedures: array(
        new Procedure(
            ...
            price: '2995 kr',
            savings: null,
            booking_url: 'https://boka.acnespecialisten.se?flow=exceed&area=Microneedling_1xArea&procedures=PriceClass_6_Procedure_1',
            booking_url_label: 'Boka',
            booking_url_title: 'Boka tid för 1 behandling',
        ),
        new Procedure(
            label: '3 behandlingar',
            price: '7995 kr',
            savings: 'Spara 990 kr',
            booking_url: 'https://boka.acnespecialisten.se?flow=exceed&area=Microneedling_1xArea&procedures=PriceClass_6_Procedure_3',
            booking_url_label: 'Boka',
            booking_url_title: 'Boka tid för 3 behandlingar',
        ),
        new Procedure(
            label: '5 behandlingar',
            price: '10995 kr',
            savings: 'Spara 3980 kr',
            booking_url: 'https://boka.acnespecialisten.se?flow=exceed&area=Microneedling_1xArea&procedures=PriceClass_6_Procedure_5',
            booking_url_label: 'Boka',
            booking_url_title: 'Boka tid för 5 behandlingar',
        )
    ),
);
    ...
    new TreatmentArea(
        ...
        items: array(
            new TreatmentAreaItem(
                ...
                duration: '50 min',
                price: '2995 kr',
                url: 'https://boka.acnespecialisten.se?flow=exceed&area=Microneedling_1xArea&procedures=PriceClass_6_Procedure_1',
                url_label: 'Boka',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Exceed-behandlingar',
        image_title: 'Cazzandra L - Expert på Exceed-behandlingar'
    ),
    new Specialist(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom Exceed-behandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på Exceed'
    ),
    new Specialist(
        name: 'Vilma Libom',
...
<head>
    ...
    <link rel="canonical" href="https://www.acnespecialisten.se/varumarken/exceed/" />
