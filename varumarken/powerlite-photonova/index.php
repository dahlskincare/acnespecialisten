...
$specialists = array(
    ...
    new Specialist(
        ...
        image_alt: 'Julia Eklund, hudterapeut med kunskap inom Powerlite Photonova behandlingar',
        image_title: 'Julia Eklund - Hudterapeut specialiserad på Powerlite Photonova'
    ),
    new Specialist(
        name: 'Vilma Libom',
