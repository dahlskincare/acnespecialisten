...
$model = new Service(
    ...
    booking_url: 'https://boka.acnespecialisten.se?flow=co2laser&skipable_problem=SKIP',
...
$specialists = array(
    new Specialist(
        ...
        image_alt: 'Cazzandra L, hudterapeut med specialisering i Fraction CO2-behandlingar',
        image_title: 'Cazzandra L - Expert på Fraction CO2-behandlingar'
    ),
    new Specialist(
