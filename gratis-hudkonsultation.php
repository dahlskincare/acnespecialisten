...
$model = new Service(
    ...
    consultation_url: 'https://www.acnespecialisten.se/book?flow=consultation',
    ...
    booking_url: 'https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Skin_Consultation&Consultationwhat=EMPTY&ConsultationPlace=consultation_online',
                ...
                <section id="types" class="large-margin">
                    ...
                    <div class="consultation-type">
                        ...
                        <div class="consultation-type-button">
                            <a href="https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Problem_Consultation" title="Boka problemhy konsultation" class="button expand">Boka konsultation</a>
                        </div>
                    </div>
                    <div class="consultation-type">
                        <div class="consultation-type-text">
                        ...
                        <div class="consultation-type-button">
                            <a href="https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Service_Consultation" title="Boka behandlings konsultation" class="button expand">Boka konsultation</a>
                        </div>
                    </div>
                    <div class="consultation-type">
                        <div class="consultation-type-text">
                        ...
                        <div class="consultation-type-button">
                            <a href="https://www.acnespecialisten.se/book?flow=consultation&ConsultationType=Brand_Consultation" title="Boka varumärkes konsultation" class="button expand">Boka konsultation</a>
                        </div>
                    </div>
                </section>
